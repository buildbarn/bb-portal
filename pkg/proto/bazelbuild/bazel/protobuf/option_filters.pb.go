...
const file_src_main_protobuf_option_filters_proto_rawDesc = "" +
	...
	"\x10NON_CONFIGURABLE\x10\b\"\x04\b\x05\x10\x05\"\x04\b\x06\x10\x06\"\x04\b\a\x10\a*%TRIGGERED_BY_ALL_INCOMPATIBLE_CHANGES*\x17EXPLICIT_IN_OUTPUT_PATH*\tIMMUTABLEB*\n" +
