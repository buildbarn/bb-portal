...
func (BuildEventId_FetchId_Downloader) EnumDescriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_proto_build_event_stream_proto_rawDescGZIP(), []int{0, 7, 0}
}
...
func (ConvenienceSymlink_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_proto_build_event_stream_proto_enumTypes[5].Descriptor()
}

func (ConvenienceSymlink_Action) Type() protoreflect.EnumType {
	return &file_src_main_java_com_google_devtools_build_lib_buildeventstream_proto_build_event_stream_proto_enumTypes[5]
}
...
func (*BuildMetrics_RemoteAnalysisCacheStatistics) Descriptor() ([]byte, []int) {
	return file_src_main_java_com_google_devtools_build_lib_buildeventstream_proto_build_event_stream_proto_rawDescGZIP(), []int{23, 13}
}
...
func (x *BuildMetrics_DynamicExecutionMetrics_RaceStatistics) Reset() {
	*x = BuildMetrics_DynamicExecutionMetrics_RaceStatistics{}
	mi := &file_src_main_java_com_google_devtools_build_lib_buildeventstream_proto_build_event_stream_proto_msgTypes[89]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_src_main_java_com_google_devtools_build_lib_buildeventstream_proto_build_event_stream_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_src_main_java_com_google_devtools_build_lib_buildeventstream_proto_build_event_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 90)
