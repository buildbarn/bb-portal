...
import { Layout, Button, Drawer, Divider, Input } from 'antd';
...
const AppBar: React.FC<Props> = ({ toggleTheme, prefersDark, extraMenuItems }) => {
          ...
          {showSiderBar ? (
            <>
              <div className={styles.appBarMenuContainer}>
                <AppBarMenu mode="horizontal" items={APP_BAR_MENU_ITEMS} className={styles.appBarMenu} />
              </div>
