  ...
  return (
    ...
    >
      ...
      <Typography.Text>
        ...
        Remote Execution API provides no functions for iterating over them. One
        may therefore only access this service in a meaningful way by visiting
        automatically generated URLs pointing to this page. Tools that are part
        of Buildbarn will generate these URLs where applicable.
      </Typography.Text>
        ...
        <ul className={styles.welcomeList}>
          ...
          <li>
            ...
            <p>
              ...
              permitted to be stored in the AC, but was stored in the CAS
          ...
          <li>
            ...
            <p>
              Displays information about a Directory contained in a Tree stored
              in the CAS.
            </p>
          </li>
        </ul>
