  ...
  fromJSON(object: any): AuthenticationMetadata {
    return {
      ...
      tracingAttributes: globalThis.Array.isArray(object?.tracingAttributes)
        ...
        : globalThis.Array.isArray(object?.tracing_attributes)
        ? object.tracing_attributes.map((e: any) => KeyValue.fromJSON(e))
        : [],
...
export const AuthenticateRequest: MessageFns<AuthenticateRequest> = {
  encode(message: AuthenticateRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.requestMetadata).forEach(
      ([key, value]: [string, AuthenticateRequest_ValueList]) => {
  ...
  fromJSON(object: any): AuthenticateRequest {
    return {
      requestMetadata: isObject(object.requestMetadata)
        ? (globalThis.Object.entries(object.requestMetadata) as [string, any][]).reduce(
          (acc: { [key: string]: AuthenticateRequest_ValueList }, [key, value]: [string, any]) => {
            acc[key] = AuthenticateRequest_ValueList.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.request_metadata)
        ? (globalThis.Object.entries(object.request_metadata) as [string, any][]).reduce(
          (acc: { [key: string]: AuthenticateRequest_ValueList }, [key, value]: [string, any]) => {
            acc[key] = AuthenticateRequest_ValueList.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: AuthenticateRequest): unknown {
    ...
    if (message.requestMetadata) {
      const entries = globalThis.Object.entries(message.requestMetadata) as [string, AuthenticateRequest_ValueList][];
      if (entries.length > 0) {
        obj.requestMetadata = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<AuthenticateRequest>): AuthenticateRequest {
    ...
    message.requestMetadata =
      (globalThis.Object.entries(object.requestMetadata ?? {}) as [string, AuthenticateRequest_ValueList][]).reduce(
        (
          acc: { [key: string]: AuthenticateRequest_ValueList },
          [key, value]: [string, AuthenticateRequest_ValueList],
        ) => {
          if (value !== undefined) {
  ...
  fromJSON(object: any): AuthenticateResponse {
    return {
      ...
      cacheExpirationTime: isSet(object.cacheExpirationTime)
        ...
        : isSet(object.cache_expiration_time)
        ? fromJsonTimestamp(object.cache_expiration_time)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): AuthorizeRequest {
    return {
      authenticationMetadata: isSet(object.authenticationMetadata)
        ...
        : isSet(object.authentication_metadata)
        ? AuthenticationMetadata.fromJSON(object.authentication_metadata)
        : undefined,
      scope: isSet(object?.scope) ? object.scope : undefined,
...
export const AuthenticationDefinition = {
  ...
  methods: {
    ...
    authenticate: {
      name: "Authenticate",
      requestType: AuthenticateRequest as typeof AuthenticateRequest,
      requestStream: false,
      responseType: AuthenticateResponse as typeof AuthenticateResponse,
...
export const AuthorizerDefinition = {
  ...
  methods: {
    ...
    authorize: {
      ...
      requestStream: false,
      responseType: AuthorizeResponse as typeof AuthorizeResponse,
      responseStream: false,
      options: {},
    },
  },
