  ...
  fromJSON(object: any): HistoricalExecuteResponse {
    return {
      actionDigest: isSet(object.actionDigest)
        ...
        : undefined,
      executeResponse: isSet(object.executeResponse)
        ? ExecuteResponse.fromJSON(object.executeResponse)
        : isSet(object.execute_response)
        ? ExecuteResponse.fromJSON(object.execute_response)
        : undefined,
    };
  },
