...
export const FilePoolResourceUsage: MessageFns<FilePoolResourceUsage> = {
  ...
  fromJSON(object: any): FilePoolResourceUsage {
    return {
      filesCreated: isSet(object.filesCreated)
        ? globalThis.String(object.filesCreated)
        : isSet(object.files_created)
        ? globalThis.String(object.files_created)
        : "0",
      filesCountPeak: isSet(object.filesCountPeak)
        ? globalThis.String(object.filesCountPeak)
        : isSet(object.files_count_peak)
        ? globalThis.String(object.files_count_peak)
        : "0",
      filesSizeBytesPeak: isSet(object.filesSizeBytesPeak)
        ? globalThis.String(object.filesSizeBytesPeak)
        : isSet(object.files_size_bytes_peak)
        ? globalThis.String(object.files_size_bytes_peak)
        : "0",
      readsCount: isSet(object.readsCount)
        ? globalThis.String(object.readsCount)
        : isSet(object.reads_count)
        ? globalThis.String(object.reads_count)
        : "0",
      readsSizeBytes: isSet(object.readsSizeBytes)
        ? globalThis.String(object.readsSizeBytes)
        : isSet(object.reads_size_bytes)
        ? globalThis.String(object.reads_size_bytes)
        : "0",
      writesCount: isSet(object.writesCount)
        ? globalThis.String(object.writesCount)
        : isSet(object.writes_count)
        ? globalThis.String(object.writes_count)
        : "0",
      writesSizeBytes: isSet(object.writesSizeBytes)
        ? globalThis.String(object.writesSizeBytes)
        : isSet(object.writes_size_bytes)
        ? globalThis.String(object.writes_size_bytes)
        : "0",
      truncatesCount: isSet(object.truncatesCount)
        ? globalThis.String(object.truncatesCount)
        : isSet(object.truncates_count)
        ? globalThis.String(object.truncates_count)
        : "0",
    };
  },
...
export const POSIXResourceUsage: MessageFns<POSIXResourceUsage> = {
  ...
  fromJSON(object: any): POSIXResourceUsage {
    return {
      userTime: isSet(object.userTime)
        ? Duration.fromJSON(object.userTime)
        : isSet(object.user_time)
        ? Duration.fromJSON(object.user_time)
        : undefined,
      systemTime: isSet(object.systemTime)
        ? Duration.fromJSON(object.systemTime)
        : isSet(object.system_time)
        ? Duration.fromJSON(object.system_time)
        : undefined,
      maximumResidentSetSize: isSet(object.maximumResidentSetSize)
        ? globalThis.String(object.maximumResidentSetSize)
        : isSet(object.maximum_resident_set_size)
        ? globalThis.String(object.maximum_resident_set_size)
        : "0",
      pageReclaims: isSet(object.pageReclaims)
        ? globalThis.String(object.pageReclaims)
        : isSet(object.page_reclaims)
        ? globalThis.String(object.page_reclaims)
        : "0",
      pageFaults: isSet(object.pageFaults)
        ? globalThis.String(object.pageFaults)
        : isSet(object.page_faults)
        ? globalThis.String(object.page_faults)
        : "0",
      swaps: isSet(object.swaps) ? globalThis.String(object.swaps) : "0",
      blockInputOperations: isSet(object.blockInputOperations)
        ? globalThis.String(object.blockInputOperations)
        : isSet(object.block_input_operations)
        ? globalThis.String(object.block_input_operations)
        : "0",
      blockOutputOperations: isSet(object.blockOutputOperations)
        ? globalThis.String(object.blockOutputOperations)
        : isSet(object.block_output_operations)
        ? globalThis.String(object.block_output_operations)
        : "0",
      ...
      messagesReceived: isSet(object.messagesReceived)
        ...
        : "0",
      signalsReceived: isSet(object.signalsReceived)
        ? globalThis.String(object.signalsReceived)
        : isSet(object.signals_received)
        ? globalThis.String(object.signals_received)
        : "0",
      voluntaryContextSwitches: isSet(object.voluntaryContextSwitches)
        ? globalThis.String(object.voluntaryContextSwitches)
        : isSet(object.voluntary_context_switches)
        ? globalThis.String(object.voluntary_context_switches)
        : "0",
      involuntaryContextSwitches: isSet(object.involuntaryContextSwitches)
        ? globalThis.String(object.involuntaryContextSwitches)
        : isSet(object.involuntary_context_switches)
        ? globalThis.String(object.involuntary_context_switches)
        : "0",
      terminationSignal: isSet(object.terminationSignal)
        ? globalThis.String(object.terminationSignal)
        : isSet(object.termination_signal)
        ? globalThis.String(object.termination_signal)
        : "",
    };
  },
...
export const MonetaryResourceUsage: MessageFns<MonetaryResourceUsage> = {
  encode(message: MonetaryResourceUsage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.expenses).forEach(([key, value]: [string, MonetaryResourceUsage_Expense]) => {
  ...
  fromJSON(object: any): MonetaryResourceUsage {
    return {
      expenses: isObject(object.expenses)
        ? (globalThis.Object.entries(object.expenses) as [string, any][]).reduce(
          (acc: { [key: string]: MonetaryResourceUsage_Expense }, [key, value]: [string, any]) => {
  ...
  toJSON(message: MonetaryResourceUsage): unknown {
    const obj: any = {};
    if (message.expenses) {
      const entries = globalThis.Object.entries(message.expenses) as [string, MonetaryResourceUsage_Expense][];
      if (entries.length > 0) {
        obj.expenses = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<MonetaryResourceUsage>): MonetaryResourceUsage {
    const message = createBaseMonetaryResourceUsage();
    message.expenses = (globalThis.Object.entries(object.expenses ?? {}) as [string, MonetaryResourceUsage_Expense][])
      .reduce(
        (
          acc: { [key: string]: MonetaryResourceUsage_Expense },
          [key, value]: [string, MonetaryResourceUsage_Expense],
        ) => {
          if (value !== undefined) {
...
export const InputRootResourceUsage: MessageFns<InputRootResourceUsage> = {
  ...
  fromJSON(object: any): InputRootResourceUsage {
    return {
      directoriesResolved: isSet(object.directoriesResolved)
        ? globalThis.String(object.directoriesResolved)
        : isSet(object.directories_resolved)
        ? globalThis.String(object.directories_resolved)
        : "0",
      directoriesRead: isSet(object.directoriesRead)
        ? globalThis.String(object.directoriesRead)
        : isSet(object.directories_read)
        ? globalThis.String(object.directories_read)
        : "0",
      filesRead: isSet(object.filesRead)
        ? globalThis.String(object.filesRead)
        : isSet(object.files_read)
        ? globalThis.String(object.files_read)
        : "0",
    };
  },
