  ...
  fromJSON(object: any): PreviousExecution {
    return {
      ...
      timedOut: isSet(object.timedOut)
        ? Duration.fromJSON(object.timedOut)
        : isSet(object.timed_out)
        ? Duration.fromJSON(object.timed_out)
        : undefined,
  ...
  fromJSON(object: any): PerSizeClassStats {
    return {
      previousExecutions: globalThis.Array.isArray(object?.previousExecutions)
        ...
        : globalThis.Array.isArray(object?.previous_executions)
        ? object.previous_executions.map((e: any) => PreviousExecution.fromJSON(e))
        : [],
      initialPageRankProbability: isSet(object.initialPageRankProbability)
        ? globalThis.Number(object.initialPageRankProbability)
        : isSet(object.initial_page_rank_probability)
        ? globalThis.Number(object.initial_page_rank_probability)
        : 0,
    };
  },
...
export const PreviousExecutionStats: MessageFns<PreviousExecutionStats> = {
  encode(message: PreviousExecutionStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.sizeClasses).forEach(([key, value]: [string, PerSizeClassStats]) => {
  ...
  fromJSON(object: any): PreviousExecutionStats {
    return {
      sizeClasses: isObject(object.sizeClasses)
        ? (globalThis.Object.entries(object.sizeClasses) as [string, any][]).reduce(
          (acc: { [key: number]: PerSizeClassStats }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = PerSizeClassStats.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.size_classes)
        ? (globalThis.Object.entries(object.size_classes) as [string, any][]).reduce(
          (acc: { [key: number]: PerSizeClassStats }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = PerSizeClassStats.fromJSON(value);
            return acc;
          },
        ...
        : {},
      lastSeenFailure: isSet(object.lastSeenFailure)
        ? fromJsonTimestamp(object.lastSeenFailure)
        : isSet(object.last_seen_failure)
        ? fromJsonTimestamp(object.last_seen_failure)
        : undefined,
    };
  },
  ...
  toJSON(message: PreviousExecutionStats): unknown {
    ...
    if (message.sizeClasses) {
      const entries = globalThis.Object.entries(message.sizeClasses) as [string, PerSizeClassStats][];
      if (entries.length > 0) {
        obj.sizeClasses = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<PreviousExecutionStats>): PreviousExecutionStats {
    const message = createBasePreviousExecutionStats();
    message.sizeClasses = (globalThis.Object.entries(object.sizeClasses ?? {}) as [string, PerSizeClassStats][]).reduce(
      (acc: { [key: number]: PerSizeClassStats }, [key, value]: [string, PerSizeClassStats]) => {
        if (value !== undefined) {
  ...
  fromJSON(object: any): GetPreviousExecutionStatsRequest {
    return {
      instanceName: isSet(object.instanceName)
        ...
        : "",
      reducedActionDigest: isSet(object.reducedActionDigest)
        ? Digest.fromJSON(object.reducedActionDigest)
        : isSet(object.reduced_action_digest)
        ? Digest.fromJSON(object.reduced_action_digest)
        : undefined,
  ...
  fromJSON(object: any): UpdatePreviousExecutionStatsRequest {
    return {
      ...
      previousExecutionStats: isSet(object.previousExecutionStats)
        ...
        : isSet(object.previous_execution_stats)
        ? PreviousExecutionStats.fromJSON(object.previous_execution_stats)
        : undefined,
      digestFunction: isSet(object.digestFunction)
        ? digestFunction_ValueFromJSON(object.digestFunction)
        : isSet(object.digest_function)
...
export const InitialSizeClassCacheDefinition = {
  ...
  methods: {
    ...
    getPreviousExecutionStats: {
      ...
      requestType: GetPreviousExecutionStatsRequest as typeof GetPreviousExecutionStatsRequest,
      requestStream: false,
      responseType: PreviousExecutionStats as typeof PreviousExecutionStats,
    ...
    updatePreviousExecutionStats: {
      ...
      requestType: UpdatePreviousExecutionStatsRequest as typeof UpdatePreviousExecutionStatsRequest,
      requestStream: false,
