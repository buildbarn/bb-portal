...
export const FileSystemAccessProfileReference: MessageFns<FileSystemAccessProfileReference> = {
  ...
  fromJSON(object: any): FileSystemAccessProfileReference {
    return {
      ...
      pathHashesBaseHash: isSet(object.pathHashesBaseHash)
        ? globalThis.String(object.pathHashesBaseHash)
        : isSet(object.path_hashes_base_hash)
        ? globalThis.String(object.path_hashes_base_hash)
        : "0",
    };
  },
