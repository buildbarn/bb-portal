...
export const OperationsDefinition = {
  ...
  methods: {
    ...
    listOperations: {
      ...
      options: {
        _unknownFields: {
          8410: [new Uint8Array([11, 110, 97, 109, 101, 44, 102, 105, 108, 116, 101, 114]) as Uint8Array],
          578365826: [
            new Uint8Array([
              23,
              18,
    ...
    deleteOperation: {
      ...
      requestType: DeleteOperationRequest as typeof DeleteOperationRequest,
      requestStream: false,
    ...
    waitOperation: {
      name: "WaitOperation",
      requestType: WaitOperationRequest as typeof WaitOperationRequest,
      requestStream: false,
      responseType: Operation as typeof Operation,
      responseStream: false,
      options: {},
