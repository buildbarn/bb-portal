  ...
  fromJSON(object: any): ReadRequest {
    return {
      resourceName: isSet(object.resourceName)
        ...
        : "",
      readOffset: isSet(object.readOffset)
        ? globalThis.String(object.readOffset)
        : isSet(object.read_offset)
        ? globalThis.String(object.read_offset)
        : "0",
      readLimit: isSet(object.readLimit)
        ? globalThis.String(object.readLimit)
        : isSet(object.read_limit)
        ? globalThis.String(object.read_limit)
        : "0",
    };
  },
  ...
  fromJSON(object: any): WriteRequest {
    return {
      ...
      writeOffset: isSet(object.writeOffset)
        ...
        : "0",
      finishWrite: isSet(object.finishWrite)
        ? globalThis.Boolean(object.finishWrite)
        : isSet(object.finish_write)
        ? globalThis.Boolean(object.finish_write)
        : false,
...
export const WriteResponse: MessageFns<WriteResponse> = {
  ...
  fromJSON(object: any): WriteResponse {
    return {
      committedSize: isSet(object.committedSize)
        ? globalThis.String(object.committedSize)
        : isSet(object.committed_size)
        ? globalThis.String(object.committed_size)
        : "0",
    };
  },
...
export const ByteStreamDefinition = {
  ...
  methods: {
    ...
    read: {
      name: "Read",
      requestType: ReadRequest as typeof ReadRequest,
      requestStream: false,
      responseType: ReadResponse as typeof ReadResponse,
      responseStream: true,
      options: {},
    },
    /**
    ...
    write: {
      name: "Write",
      requestType: WriteRequest as typeof WriteRequest,
      requestStream: true,
      responseType: WriteResponse as typeof WriteResponse,
    ...
    queryWriteStatus: {
      ...
      requestType: QueryWriteStatusRequest as typeof QueryWriteStatusRequest,
      requestStream: false,
      responseType: QueryWriteStatusResponse as typeof QueryWriteStatusResponse,
      responseStream: false,
      options: {},
    },
  },
