...
const (
	// Label holds the string label denoting the buildgraphevaluationstat type in the database.
	Label = "build_graph_evaluation_stat"
	...
	// Table holds the table name of the buildgraphevaluationstat in the database.
	Table = "build_graph_evaluation_stats"
	// BuildGraphMetricsTable is the table that holds the build_graph_metrics relation/edge.
	BuildGraphMetricsTable = "build_graph_evaluation_stats"
	...
	BuildGraphMetricsColumn = "build_graph_metrics_evaluation_stats"
)

// Columns holds all SQL columns for buildgraphevaluationstat fields.
var Columns = []string{
	FieldID,
	FieldOperation,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "build_graph_evaluation_stats"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"build_graph_metrics_evaluation_stats",
}
...
// OrderOption defines the ordering options for the BuildGraphEvaluationStat queries.
