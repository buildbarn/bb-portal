...
const (
	...
	RaceStatisticsTable = "dynamic_execution_race_statistics"
	// RaceStatisticsInverseTable is the table name for the DynamicExecutionRaceStatistic entity.
	// It exists in this package in order to avoid circular dependency with the "dynamicexecutionracestatistic" package.
	RaceStatisticsInverseTable = "dynamic_execution_race_statistics"
