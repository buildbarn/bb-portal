...
// was not loaded in eager-loading.
func (e ConfigurationEdges) ActionExecutionsOrErr() ([]*ActionExecution, error) {
	if e.loadedTypes[2] {
...
// QueryActionExecutions queries the "action_executions" edge of the Configuration entity.
func (_m *Configuration) QueryActionExecutions() *ActionExecutionQuery {
	return NewConfigurationClient(_m.config).QueryActionExecutions(_m)
}
...
// loaded in eager-loading with this name.
func (_m *Configuration) NamedActionExecutions(name string) ([]*ActionExecution, error) {
...
func (_m *Configuration) appendNamedActionExecutions(name string, edges ...*ActionExecution) {
	if _m.Edges.namedActionExecutions == nil {
