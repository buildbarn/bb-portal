...
// LoadDurationInNs applies equality check predicate on the "load_duration_in_ns" field. It's identical to LoadDurationInNsEQ.
func LoadDurationInNs(v int64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldEQ(FieldLoadDurationInNs, v))
}
...
// GlobFilesystemOperationCost applies equality check predicate on the "glob_filesystem_operation_cost" field. It's identical to GlobFilesystemOperationCostEQ.
func GlobFilesystemOperationCost(v uint64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldEQ(FieldGlobFilesystemOperationCost, v))
}
...
// LoadDurationInNsEQ applies the EQ predicate on the "load_duration_in_ns" field.
func LoadDurationInNsEQ(v int64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldEQ(FieldLoadDurationInNs, v))
}

// LoadDurationInNsNEQ applies the NEQ predicate on the "load_duration_in_ns" field.
func LoadDurationInNsNEQ(v int64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldNEQ(FieldLoadDurationInNs, v))
}

// LoadDurationInNsIn applies the In predicate on the "load_duration_in_ns" field.
func LoadDurationInNsIn(vs ...int64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldIn(FieldLoadDurationInNs, vs...))
}

// LoadDurationInNsNotIn applies the NotIn predicate on the "load_duration_in_ns" field.
func LoadDurationInNsNotIn(vs ...int64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldNotIn(FieldLoadDurationInNs, vs...))
}

// LoadDurationInNsGT applies the GT predicate on the "load_duration_in_ns" field.
func LoadDurationInNsGT(v int64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldGT(FieldLoadDurationInNs, v))
}

// LoadDurationInNsGTE applies the GTE predicate on the "load_duration_in_ns" field.
func LoadDurationInNsGTE(v int64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldGTE(FieldLoadDurationInNs, v))
}

// LoadDurationInNsLT applies the LT predicate on the "load_duration_in_ns" field.
func LoadDurationInNsLT(v int64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldLT(FieldLoadDurationInNs, v))
}

// LoadDurationInNsLTE applies the LTE predicate on the "load_duration_in_ns" field.
func LoadDurationInNsLTE(v int64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldLTE(FieldLoadDurationInNs, v))
}

// LoadDurationInNsIsNil applies the IsNil predicate on the "load_duration_in_ns" field.
func LoadDurationInNsIsNil() predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldIsNull(FieldLoadDurationInNs))
}

// LoadDurationInNsNotNil applies the NotNil predicate on the "load_duration_in_ns" field.
func LoadDurationInNsNotNil() predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldNotNull(FieldLoadDurationInNs))
}
...
// GlobFilesystemOperationCostEQ applies the EQ predicate on the "glob_filesystem_operation_cost" field.
func GlobFilesystemOperationCostEQ(v uint64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldEQ(FieldGlobFilesystemOperationCost, v))
}

// GlobFilesystemOperationCostNEQ applies the NEQ predicate on the "glob_filesystem_operation_cost" field.
func GlobFilesystemOperationCostNEQ(v uint64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldNEQ(FieldGlobFilesystemOperationCost, v))
}

// GlobFilesystemOperationCostIn applies the In predicate on the "glob_filesystem_operation_cost" field.
func GlobFilesystemOperationCostIn(vs ...uint64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldIn(FieldGlobFilesystemOperationCost, vs...))
}

// GlobFilesystemOperationCostNotIn applies the NotIn predicate on the "glob_filesystem_operation_cost" field.
func GlobFilesystemOperationCostNotIn(vs ...uint64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldNotIn(FieldGlobFilesystemOperationCost, vs...))
}

// GlobFilesystemOperationCostGT applies the GT predicate on the "glob_filesystem_operation_cost" field.
func GlobFilesystemOperationCostGT(v uint64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldGT(FieldGlobFilesystemOperationCost, v))
}

// GlobFilesystemOperationCostGTE applies the GTE predicate on the "glob_filesystem_operation_cost" field.
func GlobFilesystemOperationCostGTE(v uint64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldGTE(FieldGlobFilesystemOperationCost, v))
}

// GlobFilesystemOperationCostLT applies the LT predicate on the "glob_filesystem_operation_cost" field.
func GlobFilesystemOperationCostLT(v uint64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldLT(FieldGlobFilesystemOperationCost, v))
}

// GlobFilesystemOperationCostLTE applies the LTE predicate on the "glob_filesystem_operation_cost" field.
func GlobFilesystemOperationCostLTE(v uint64) predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldLTE(FieldGlobFilesystemOperationCost, v))
}

// GlobFilesystemOperationCostIsNil applies the IsNil predicate on the "glob_filesystem_operation_cost" field.
func GlobFilesystemOperationCostIsNil() predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldIsNull(FieldGlobFilesystemOperationCost))
}

// GlobFilesystemOperationCostNotNil applies the NotNil predicate on the "glob_filesystem_operation_cost" field.
func GlobFilesystemOperationCostNotNil() predicate.PackageLoadMetrics {
	return predicate.PackageLoadMetrics(sql.FieldNotNull(FieldGlobFilesystemOperationCost))
}
