...
func (biu *BazelInvocationUpdate) SetArtifactGraphID(id int64) *BazelInvocationUpdate {
	biu.mutation.SetArtifactGraphID(id)
	return biu
}
...
func (biu *BazelInvocationUpdate) SetNillableArtifactGraphID(id *int64) *BazelInvocationUpdate {
	if id != nil {
		biu = biu.SetArtifactGraphID(*id)
	}
	return biu
}

// SetArtifactGraph sets the "artifact_graph" edge to the InvocationArtifactGraph entity.
func (biu *BazelInvocationUpdate) SetArtifactGraph(i *InvocationArtifactGraph) *BazelInvocationUpdate {
	return biu.SetArtifactGraphID(i.ID)
}
...
func (biu *BazelInvocationUpdate) ClearArtifactGraph() *BazelInvocationUpdate {
	biu.mutation.ClearArtifactGraph()
	return biu
}
...
func (biu *BazelInvocationUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if biu.mutation.ArtifactGraphCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
	...
	if nodes := biu.mutation.ArtifactGraphIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   bazelinvocation.ArtifactGraphTable,
...
// SetArtifactGraphID sets the "artifact_graph" edge to the InvocationArtifactGraph entity by ID.
func (biuo *BazelInvocationUpdateOne) SetArtifactGraphID(id int64) *BazelInvocationUpdateOne {
	biuo.mutation.SetArtifactGraphID(id)
	return biuo
}

// SetNillableArtifactGraphID sets the "artifact_graph" edge to the InvocationArtifactGraph entity by ID if the given value is not nil.
func (biuo *BazelInvocationUpdateOne) SetNillableArtifactGraphID(id *int64) *BazelInvocationUpdateOne {
	if id != nil {
		biuo = biuo.SetArtifactGraphID(*id)
	}
	return biuo
}

// SetArtifactGraph sets the "artifact_graph" edge to the InvocationArtifactGraph entity.
func (biuo *BazelInvocationUpdateOne) SetArtifactGraph(i *InvocationArtifactGraph) *BazelInvocationUpdateOne {
	return biuo.SetArtifactGraphID(i.ID)
}
...
// ClearArtifactGraph clears the "artifact_graph" edge to the InvocationArtifactGraph entity.
func (biuo *BazelInvocationUpdateOne) ClearArtifactGraph() *BazelInvocationUpdateOne {
	biuo.mutation.ClearArtifactGraph()
	return biuo
}
...
func (biuo *BazelInvocationUpdateOne) sqlSave(ctx context.Context) (_node *BazelInvocation, err error) {
	...
	if biuo.mutation.ArtifactGraphCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   bazelinvocation.ArtifactGraphTable,
	...
	if nodes := biuo.mutation.ArtifactGraphIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   bazelinvocation.ArtifactGraphTable,
