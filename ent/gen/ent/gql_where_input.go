...
// ActionExecutionWhereInput represents a where input for filtering ActionExecution queries.
type ActionExecutionWhereInput struct {
	Predicates []predicate.ActionExecution  `json:"-"`
	Not        *ActionExecutionWhereInput   `json:"not,omitempty"`
	Or         []*ActionExecutionWhereInput `json:"or,omitempty"`
	And        []*ActionExecutionWhereInput `json:"and,omitempty"`
...
// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *ActionExecutionWhereInput) AddPredicates(predicates ...predicate.ActionExecution) {
	i.Predicates = append(i.Predicates, predicates...)
}

// Filter applies the ActionExecutionWhereInput filter on the ActionExecutionQuery builder.
func (i *ActionExecutionWhereInput) Filter(q *ActionExecutionQuery) (*ActionExecutionQuery, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyActionExecutionWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyActionExecutionWhereInput is returned in case the ActionExecutionWhereInput is empty.
var ErrEmptyActionExecutionWhereInput = errors.New("ent: empty predicate ActionExecutionWhereInput")

// P returns a predicate for filtering actionexecutions.
// An error is returned if the input is empty or invalid.
func (i *ActionExecutionWhereInput) P() (predicate.ActionExecution, error) {
	var predicates []predicate.ActionExecution
	if i.Not != nil {
		p, err := i.Not.P()
		if err != nil {
			return nil, fmt.Errorf("%w: field 'not'", err)
		}
		predicates = append(predicates, actionexecution.Not(p))
	}
	switch n := len(i.Or); {
	case n == 1:
		p, err := i.Or[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		or := make([]predicate.ActionExecution, 0, n)
		for _, w := range i.Or {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'or'", err)
		...
		predicates = append(predicates, actionexecution.Or(or...))
	}
	switch n := len(i.And); {
	case n == 1:
		p, err := i.And[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		and := make([]predicate.ActionExecution, 0, n)
		for _, w := range i.And {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'and'", err)
		...
		predicates = append(predicates, actionexecution.And(and...))
	}
	predicates = append(predicates, i.Predicates...)
	if i.ID != nil {
		predicates = append(predicates, actionexecution.IDEQ(*i.ID))
	}
	if i.IDNEQ != nil {
		predicates = append(predicates, actionexecution.IDNEQ(*i.IDNEQ))
	}
	if len(i.IDIn) > 0 {
		predicates = append(predicates, actionexecution.IDIn(i.IDIn...))
	}
	if len(i.IDNotIn) > 0 {
		predicates = append(predicates, actionexecution.IDNotIn(i.IDNotIn...))
	}
	if i.IDGT != nil {
		predicates = append(predicates, actionexecution.IDGT(*i.IDGT))
	}
	if i.IDGTE != nil {
		predicates = append(predicates, actionexecution.IDGTE(*i.IDGTE))
	}
	if i.IDLT != nil {
		predicates = append(predicates, actionexecution.IDLT(*i.IDLT))
	}
	if i.IDLTE != nil {
		predicates = append(predicates, actionexecution.IDLTE(*i.IDLTE))
	}
	if i.Label != nil {
		predicates = append(predicates, actionexecution.LabelEQ(*i.Label))
	}
	if i.LabelNEQ != nil {
		predicates = append(predicates, actionexecution.LabelNEQ(*i.LabelNEQ))
	}
	if len(i.LabelIn) > 0 {
		predicates = append(predicates, actionexecution.LabelIn(i.LabelIn...))
	}
	if len(i.LabelNotIn) > 0 {
		predicates = append(predicates, actionexecution.LabelNotIn(i.LabelNotIn...))
	}
	if i.LabelGT != nil {
		predicates = append(predicates, actionexecution.LabelGT(*i.LabelGT))
	}
	if i.LabelGTE != nil {
		predicates = append(predicates, actionexecution.LabelGTE(*i.LabelGTE))
	}
	if i.LabelLT != nil {
		predicates = append(predicates, actionexecution.LabelLT(*i.LabelLT))
	}
	if i.LabelLTE != nil {
		predicates = append(predicates, actionexecution.LabelLTE(*i.LabelLTE))
	}
	if i.LabelContains != nil {
		predicates = append(predicates, actionexecution.LabelContains(*i.LabelContains))
	}
	if i.LabelHasPrefix != nil {
		predicates = append(predicates, actionexecution.LabelHasPrefix(*i.LabelHasPrefix))
	}
	if i.LabelHasSuffix != nil {
		predicates = append(predicates, actionexecution.LabelHasSuffix(*i.LabelHasSuffix))
	}
	if i.LabelEqualFold != nil {
		predicates = append(predicates, actionexecution.LabelEqualFold(*i.LabelEqualFold))
	}
	if i.LabelContainsFold != nil {
		predicates = append(predicates, actionexecution.LabelContainsFold(*i.LabelContainsFold))
	}
	if i.Type != nil {
		predicates = append(predicates, actionexecution.TypeEQ(*i.Type))
	}
	if i.TypeNEQ != nil {
		predicates = append(predicates, actionexecution.TypeNEQ(*i.TypeNEQ))
	}
	if len(i.TypeIn) > 0 {
		predicates = append(predicates, actionexecution.TypeIn(i.TypeIn...))
	}
	if len(i.TypeNotIn) > 0 {
		predicates = append(predicates, actionexecution.TypeNotIn(i.TypeNotIn...))
	}
	if i.TypeGT != nil {
		predicates = append(predicates, actionexecution.TypeGT(*i.TypeGT))
	}
	if i.TypeGTE != nil {
		predicates = append(predicates, actionexecution.TypeGTE(*i.TypeGTE))
	}
	if i.TypeLT != nil {
		predicates = append(predicates, actionexecution.TypeLT(*i.TypeLT))
	}
	if i.TypeLTE != nil {
		predicates = append(predicates, actionexecution.TypeLTE(*i.TypeLTE))
	}
	if i.TypeContains != nil {
		predicates = append(predicates, actionexecution.TypeContains(*i.TypeContains))
	}
	if i.TypeHasPrefix != nil {
		predicates = append(predicates, actionexecution.TypeHasPrefix(*i.TypeHasPrefix))
	}
	if i.TypeHasSuffix != nil {
		predicates = append(predicates, actionexecution.TypeHasSuffix(*i.TypeHasSuffix))
	}
	if i.TypeIsNil {
		predicates = append(predicates, actionexecution.TypeIsNil())
	}
	if i.TypeNotNil {
		predicates = append(predicates, actionexecution.TypeNotNil())
	}
	if i.TypeEqualFold != nil {
		predicates = append(predicates, actionexecution.TypeEqualFold(*i.TypeEqualFold))
	}
	if i.TypeContainsFold != nil {
		predicates = append(predicates, actionexecution.TypeContainsFold(*i.TypeContainsFold))
	}
	if i.Runner != nil {
		predicates = append(predicates, actionexecution.RunnerEQ(*i.Runner))
	}
	if i.RunnerNEQ != nil {
		predicates = append(predicates, actionexecution.RunnerNEQ(*i.RunnerNEQ))
	}
	if len(i.RunnerIn) > 0 {
		predicates = append(predicates, actionexecution.RunnerIn(i.RunnerIn...))
	}
	if len(i.RunnerNotIn) > 0 {
		predicates = append(predicates, actionexecution.RunnerNotIn(i.RunnerNotIn...))
	}
	if i.RunnerGT != nil {
		predicates = append(predicates, actionexecution.RunnerGT(*i.RunnerGT))
	}
	if i.RunnerGTE != nil {
		predicates = append(predicates, actionexecution.RunnerGTE(*i.RunnerGTE))
	}
	if i.RunnerLT != nil {
		predicates = append(predicates, actionexecution.RunnerLT(*i.RunnerLT))
	}
	if i.RunnerLTE != nil {
		predicates = append(predicates, actionexecution.RunnerLTE(*i.RunnerLTE))
	}
	if i.RunnerContains != nil {
		predicates = append(predicates, actionexecution.RunnerContains(*i.RunnerContains))
	}
	if i.RunnerHasPrefix != nil {
		predicates = append(predicates, actionexecution.RunnerHasPrefix(*i.RunnerHasPrefix))
	}
	if i.RunnerHasSuffix != nil {
		predicates = append(predicates, actionexecution.RunnerHasSuffix(*i.RunnerHasSuffix))
	}
	if i.RunnerIsNil {
		predicates = append(predicates, actionexecution.RunnerIsNil())
	}
	if i.RunnerNotNil {
		predicates = append(predicates, actionexecution.RunnerNotNil())
	}
	if i.RunnerEqualFold != nil {
		predicates = append(predicates, actionexecution.RunnerEqualFold(*i.RunnerEqualFold))
	}
	if i.RunnerContainsFold != nil {
		predicates = append(predicates, actionexecution.RunnerContainsFold(*i.RunnerContainsFold))
	}
	if i.CacheHit != nil {
		predicates = append(predicates, actionexecution.CacheHitEQ(*i.CacheHit))
	}
	if i.CacheHitNEQ != nil {
		predicates = append(predicates, actionexecution.CacheHitNEQ(*i.CacheHitNEQ))
	}
	if i.CacheHitIsNil {
		predicates = append(predicates, actionexecution.CacheHitIsNil())
	}
	if i.CacheHitNotNil {
		predicates = append(predicates, actionexecution.CacheHitNotNil())
	}
	if i.Success != nil {
		predicates = append(predicates, actionexecution.SuccessEQ(*i.Success))
	}
	if i.SuccessNEQ != nil {
		predicates = append(predicates, actionexecution.SuccessNEQ(*i.SuccessNEQ))
	}
	if i.SuccessIsNil {
		predicates = append(predicates, actionexecution.SuccessIsNil())
	}
	if i.SuccessNotNil {
		predicates = append(predicates, actionexecution.SuccessNotNil())
	}
	if i.ExitCode != nil {
		predicates = append(predicates, actionexecution.ExitCodeEQ(*i.ExitCode))
	}
	if i.ExitCodeNEQ != nil {
		predicates = append(predicates, actionexecution.ExitCodeNEQ(*i.ExitCodeNEQ))
	}
	if len(i.ExitCodeIn) > 0 {
		predicates = append(predicates, actionexecution.ExitCodeIn(i.ExitCodeIn...))
	}
	if len(i.ExitCodeNotIn) > 0 {
		predicates = append(predicates, actionexecution.ExitCodeNotIn(i.ExitCodeNotIn...))
	}
	if i.ExitCodeGT != nil {
		predicates = append(predicates, actionexecution.ExitCodeGT(*i.ExitCodeGT))
	}
	if i.ExitCodeGTE != nil {
		predicates = append(predicates, actionexecution.ExitCodeGTE(*i.ExitCodeGTE))
	}
	if i.ExitCodeLT != nil {
		predicates = append(predicates, actionexecution.ExitCodeLT(*i.ExitCodeLT))
	}
	if i.ExitCodeLTE != nil {
		predicates = append(predicates, actionexecution.ExitCodeLTE(*i.ExitCodeLTE))
	}
	if i.ExitCodeIsNil {
		predicates = append(predicates, actionexecution.ExitCodeIsNil())
	}
	if i.ExitCodeNotNil {
		predicates = append(predicates, actionexecution.ExitCodeNotNil())
	}
	if i.StartTime != nil {
		predicates = append(predicates, actionexecution.StartTimeEQ(*i.StartTime))
	}
	if i.StartTimeNEQ != nil {
		predicates = append(predicates, actionexecution.StartTimeNEQ(*i.StartTimeNEQ))
	}
	if len(i.StartTimeIn) > 0 {
		predicates = append(predicates, actionexecution.StartTimeIn(i.StartTimeIn...))
	}
	if len(i.StartTimeNotIn) > 0 {
		predicates = append(predicates, actionexecution.StartTimeNotIn(i.StartTimeNotIn...))
	}
	if i.StartTimeGT != nil {
		predicates = append(predicates, actionexecution.StartTimeGT(*i.StartTimeGT))
	}
	if i.StartTimeGTE != nil {
		predicates = append(predicates, actionexecution.StartTimeGTE(*i.StartTimeGTE))
	}
	if i.StartTimeLT != nil {
		predicates = append(predicates, actionexecution.StartTimeLT(*i.StartTimeLT))
	}
	if i.StartTimeLTE != nil {
		predicates = append(predicates, actionexecution.StartTimeLTE(*i.StartTimeLTE))
	}
	if i.StartTimeIsNil {
		predicates = append(predicates, actionexecution.StartTimeIsNil())
	}
	if i.StartTimeNotNil {
		predicates = append(predicates, actionexecution.StartTimeNotNil())
	}
	if i.EndTime != nil {
		predicates = append(predicates, actionexecution.EndTimeEQ(*i.EndTime))
	}
	if i.EndTimeNEQ != nil {
		predicates = append(predicates, actionexecution.EndTimeNEQ(*i.EndTimeNEQ))
	}
	if len(i.EndTimeIn) > 0 {
		predicates = append(predicates, actionexecution.EndTimeIn(i.EndTimeIn...))
	}
	if len(i.EndTimeNotIn) > 0 {
		predicates = append(predicates, actionexecution.EndTimeNotIn(i.EndTimeNotIn...))
	}
	if i.EndTimeGT != nil {
		predicates = append(predicates, actionexecution.EndTimeGT(*i.EndTimeGT))
	}
	if i.EndTimeGTE != nil {
		predicates = append(predicates, actionexecution.EndTimeGTE(*i.EndTimeGTE))
	}
	if i.EndTimeLT != nil {
		predicates = append(predicates, actionexecution.EndTimeLT(*i.EndTimeLT))
	}
	if i.EndTimeLTE != nil {
		predicates = append(predicates, actionexecution.EndTimeLTE(*i.EndTimeLTE))
	}
	if i.EndTimeIsNil {
		predicates = append(predicates, actionexecution.EndTimeIsNil())
	}
	if i.EndTimeNotNil {
		predicates = append(predicates, actionexecution.EndTimeNotNil())
	}
	if i.FailureCode != nil {
		predicates = append(predicates, actionexecution.FailureCodeEQ(*i.FailureCode))
	}
	if i.FailureCodeNEQ != nil {
		predicates = append(predicates, actionexecution.FailureCodeNEQ(*i.FailureCodeNEQ))
	}
	if len(i.FailureCodeIn) > 0 {
		predicates = append(predicates, actionexecution.FailureCodeIn(i.FailureCodeIn...))
	}
	if len(i.FailureCodeNotIn) > 0 {
		predicates = append(predicates, actionexecution.FailureCodeNotIn(i.FailureCodeNotIn...))
	}
	if i.FailureCodeGT != nil {
		predicates = append(predicates, actionexecution.FailureCodeGT(*i.FailureCodeGT))
	}
	if i.FailureCodeGTE != nil {
		predicates = append(predicates, actionexecution.FailureCodeGTE(*i.FailureCodeGTE))
	}
	if i.FailureCodeLT != nil {
		predicates = append(predicates, actionexecution.FailureCodeLT(*i.FailureCodeLT))
	}
	if i.FailureCodeLTE != nil {
		predicates = append(predicates, actionexecution.FailureCodeLTE(*i.FailureCodeLTE))
	}
	if i.FailureCodeContains != nil {
		predicates = append(predicates, actionexecution.FailureCodeContains(*i.FailureCodeContains))
	}
	if i.FailureCodeHasPrefix != nil {
		predicates = append(predicates, actionexecution.FailureCodeHasPrefix(*i.FailureCodeHasPrefix))
	}
	if i.FailureCodeHasSuffix != nil {
		predicates = append(predicates, actionexecution.FailureCodeHasSuffix(*i.FailureCodeHasSuffix))
	}
	if i.FailureCodeIsNil {
		predicates = append(predicates, actionexecution.FailureCodeIsNil())
	}
	if i.FailureCodeNotNil {
		predicates = append(predicates, actionexecution.FailureCodeNotNil())
	}
	if i.FailureCodeEqualFold != nil {
		predicates = append(predicates, actionexecution.FailureCodeEqualFold(*i.FailureCodeEqualFold))
	}
	if i.FailureCodeContainsFold != nil {
		predicates = append(predicates, actionexecution.FailureCodeContainsFold(*i.FailureCodeContainsFold))
	}
	if i.FailureMessage != nil {
		predicates = append(predicates, actionexecution.FailureMessageEQ(*i.FailureMessage))
	}
	if i.FailureMessageNEQ != nil {
		predicates = append(predicates, actionexecution.FailureMessageNEQ(*i.FailureMessageNEQ))
	}
	if len(i.FailureMessageIn) > 0 {
		predicates = append(predicates, actionexecution.FailureMessageIn(i.FailureMessageIn...))
	}
	if len(i.FailureMessageNotIn) > 0 {
		predicates = append(predicates, actionexecution.FailureMessageNotIn(i.FailureMessageNotIn...))
	}
	if i.FailureMessageGT != nil {
		predicates = append(predicates, actionexecution.FailureMessageGT(*i.FailureMessageGT))
	}
	if i.FailureMessageGTE != nil {
		predicates = append(predicates, actionexecution.FailureMessageGTE(*i.FailureMessageGTE))
	}
	if i.FailureMessageLT != nil {
		predicates = append(predicates, actionexecution.FailureMessageLT(*i.FailureMessageLT))
	}
	if i.FailureMessageLTE != nil {
		predicates = append(predicates, actionexecution.FailureMessageLTE(*i.FailureMessageLTE))
	}
	if i.FailureMessageContains != nil {
		predicates = append(predicates, actionexecution.FailureMessageContains(*i.FailureMessageContains))
	}
	if i.FailureMessageHasPrefix != nil {
		predicates = append(predicates, actionexecution.FailureMessageHasPrefix(*i.FailureMessageHasPrefix))
	}
	if i.FailureMessageHasSuffix != nil {
		predicates = append(predicates, actionexecution.FailureMessageHasSuffix(*i.FailureMessageHasSuffix))
	}
	if i.FailureMessageIsNil {
		predicates = append(predicates, actionexecution.FailureMessageIsNil())
	}
	if i.FailureMessageNotNil {
		predicates = append(predicates, actionexecution.FailureMessageNotNil())
	}
	if i.FailureMessageEqualFold != nil {
		predicates = append(predicates, actionexecution.FailureMessageEqualFold(*i.FailureMessageEqualFold))
	}
	if i.FailureMessageContainsFold != nil {
		predicates = append(predicates, actionexecution.FailureMessageContainsFold(*i.FailureMessageContainsFold))
	}
	if i.PrimaryOutput != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputEQ(*i.PrimaryOutput))
	}
	if i.PrimaryOutputNEQ != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputNEQ(*i.PrimaryOutputNEQ))
	}
	if len(i.PrimaryOutputIn) > 0 {
		predicates = append(predicates, actionexecution.PrimaryOutputIn(i.PrimaryOutputIn...))
	}
	if len(i.PrimaryOutputNotIn) > 0 {
		predicates = append(predicates, actionexecution.PrimaryOutputNotIn(i.PrimaryOutputNotIn...))
	}
	if i.PrimaryOutputGT != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputGT(*i.PrimaryOutputGT))
	}
	if i.PrimaryOutputGTE != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputGTE(*i.PrimaryOutputGTE))
	}
	if i.PrimaryOutputLT != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputLT(*i.PrimaryOutputLT))
	}
	if i.PrimaryOutputLTE != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputLTE(*i.PrimaryOutputLTE))
	}
	if i.PrimaryOutputContains != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputContains(*i.PrimaryOutputContains))
	}
	if i.PrimaryOutputHasPrefix != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputHasPrefix(*i.PrimaryOutputHasPrefix))
	}
	if i.PrimaryOutputHasSuffix != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputHasSuffix(*i.PrimaryOutputHasSuffix))
	}
	if i.PrimaryOutputIsNil {
		predicates = append(predicates, actionexecution.PrimaryOutputIsNil())
	}
	if i.PrimaryOutputNotNil {
		predicates = append(predicates, actionexecution.PrimaryOutputNotNil())
	}
	if i.PrimaryOutputEqualFold != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputEqualFold(*i.PrimaryOutputEqualFold))
	}
	if i.PrimaryOutputContainsFold != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputContainsFold(*i.PrimaryOutputContainsFold))
	}
	if i.PrimaryOutputURI != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURIEQ(*i.PrimaryOutputURI))
	}
	if i.PrimaryOutputURINEQ != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURINEQ(*i.PrimaryOutputURINEQ))
	}
	if len(i.PrimaryOutputURIIn) > 0 {
		predicates = append(predicates, actionexecution.PrimaryOutputURIIn(i.PrimaryOutputURIIn...))
	}
	if len(i.PrimaryOutputURINotIn) > 0 {
		predicates = append(predicates, actionexecution.PrimaryOutputURINotIn(i.PrimaryOutputURINotIn...))
	}
	if i.PrimaryOutputURIGT != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURIGT(*i.PrimaryOutputURIGT))
	}
	if i.PrimaryOutputURIGTE != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURIGTE(*i.PrimaryOutputURIGTE))
	}
	if i.PrimaryOutputURILT != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURILT(*i.PrimaryOutputURILT))
	}
	if i.PrimaryOutputURILTE != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURILTE(*i.PrimaryOutputURILTE))
	}
	if i.PrimaryOutputURIContains != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURIContains(*i.PrimaryOutputURIContains))
	}
	if i.PrimaryOutputURIHasPrefix != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURIHasPrefix(*i.PrimaryOutputURIHasPrefix))
	}
	if i.PrimaryOutputURIHasSuffix != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURIHasSuffix(*i.PrimaryOutputURIHasSuffix))
	}
	if i.PrimaryOutputURIIsNil {
		predicates = append(predicates, actionexecution.PrimaryOutputURIIsNil())
	}
	if i.PrimaryOutputURINotNil {
		predicates = append(predicates, actionexecution.PrimaryOutputURINotNil())
	}
	if i.PrimaryOutputURIEqualFold != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURIEqualFold(*i.PrimaryOutputURIEqualFold))
	}
	if i.PrimaryOutputURIContainsFold != nil {
		predicates = append(predicates, actionexecution.PrimaryOutputURIContainsFold(*i.PrimaryOutputURIContainsFold))
	}
	if i.StdoutURI != nil {
		predicates = append(predicates, actionexecution.StdoutURIEQ(*i.StdoutURI))
	}
	if i.StdoutURINEQ != nil {
		predicates = append(predicates, actionexecution.StdoutURINEQ(*i.StdoutURINEQ))
	}
	if len(i.StdoutURIIn) > 0 {
		predicates = append(predicates, actionexecution.StdoutURIIn(i.StdoutURIIn...))
	}
	if len(i.StdoutURINotIn) > 0 {
		predicates = append(predicates, actionexecution.StdoutURINotIn(i.StdoutURINotIn...))
	}
	if i.StdoutURIGT != nil {
		predicates = append(predicates, actionexecution.StdoutURIGT(*i.StdoutURIGT))
	}
	if i.StdoutURIGTE != nil {
		predicates = append(predicates, actionexecution.StdoutURIGTE(*i.StdoutURIGTE))
	}
	if i.StdoutURILT != nil {
		predicates = append(predicates, actionexecution.StdoutURILT(*i.StdoutURILT))
	}
	if i.StdoutURILTE != nil {
		predicates = append(predicates, actionexecution.StdoutURILTE(*i.StdoutURILTE))
	}
	if i.StdoutURIContains != nil {
		predicates = append(predicates, actionexecution.StdoutURIContains(*i.StdoutURIContains))
	}
	if i.StdoutURIHasPrefix != nil {
		predicates = append(predicates, actionexecution.StdoutURIHasPrefix(*i.StdoutURIHasPrefix))
	}
	if i.StdoutURIHasSuffix != nil {
		predicates = append(predicates, actionexecution.StdoutURIHasSuffix(*i.StdoutURIHasSuffix))
	}
	if i.StdoutURIIsNil {
		predicates = append(predicates, actionexecution.StdoutURIIsNil())
	}
	if i.StdoutURINotNil {
		predicates = append(predicates, actionexecution.StdoutURINotNil())
	}
	if i.StdoutURIEqualFold != nil {
		predicates = append(predicates, actionexecution.StdoutURIEqualFold(*i.StdoutURIEqualFold))
	}
	if i.StdoutURIContainsFold != nil {
		predicates = append(predicates, actionexecution.StdoutURIContainsFold(*i.StdoutURIContainsFold))
	}
	if i.StderrURI != nil {
		predicates = append(predicates, actionexecution.StderrURIEQ(*i.StderrURI))
	}
	if i.StderrURINEQ != nil {
		predicates = append(predicates, actionexecution.StderrURINEQ(*i.StderrURINEQ))
	}
	if len(i.StderrURIIn) > 0 {
		predicates = append(predicates, actionexecution.StderrURIIn(i.StderrURIIn...))
	}
	if len(i.StderrURINotIn) > 0 {
		predicates = append(predicates, actionexecution.StderrURINotIn(i.StderrURINotIn...))
	}
	if i.StderrURIGT != nil {
		predicates = append(predicates, actionexecution.StderrURIGT(*i.StderrURIGT))
	}
	if i.StderrURIGTE != nil {
		predicates = append(predicates, actionexecution.StderrURIGTE(*i.StderrURIGTE))
	}
	if i.StderrURILT != nil {
		predicates = append(predicates, actionexecution.StderrURILT(*i.StderrURILT))
	}
	if i.StderrURILTE != nil {
		predicates = append(predicates, actionexecution.StderrURILTE(*i.StderrURILTE))
	}
	if i.StderrURIContains != nil {
		predicates = append(predicates, actionexecution.StderrURIContains(*i.StderrURIContains))
	}
	if i.StderrURIHasPrefix != nil {
		predicates = append(predicates, actionexecution.StderrURIHasPrefix(*i.StderrURIHasPrefix))
	}
	if i.StderrURIHasSuffix != nil {
		predicates = append(predicates, actionexecution.StderrURIHasSuffix(*i.StderrURIHasSuffix))
	}
	if i.StderrURIIsNil {
		predicates = append(predicates, actionexecution.StderrURIIsNil())
	}
	if i.StderrURINotNil {
		predicates = append(predicates, actionexecution.StderrURINotNil())
	}
	if i.StderrURIEqualFold != nil {
		predicates = append(predicates, actionexecution.StderrURIEqualFold(*i.StderrURIEqualFold))
	}
	if i.StderrURIContainsFold != nil {
		predicates = append(predicates, actionexecution.StderrURIContainsFold(*i.StderrURIContainsFold))
	}

	if i.HasBazelInvocation != nil {
		p := actionexecution.HasBazelInvocation()
		if !*i.HasBazelInvocation {
			p = actionexecution.Not(p)
		}
		predicates = append(predicates, p)
	}
	if len(i.HasBazelInvocationWith) > 0 {
		...
		predicates = append(predicates, actionexecution.HasBazelInvocationWith(with...))
	}
	if i.HasConfiguration != nil {
		p := actionexecution.HasConfiguration()
	...
	if len(i.HasConfigurationWith) > 0 {
		...
		predicates = append(predicates, actionexecution.HasConfigurationWith(with...))
	}
	if i.HasActionDigest != nil {
		p := actionexecution.HasActionDigest()
	...
	if len(i.HasActionDigestWith) > 0 {
		...
		predicates = append(predicates, actionexecution.HasActionDigestWith(with...))
	}
	switch len(predicates) {
	case 0:
		return nil, ErrEmptyActionExecutionWhereInput
	case 1:
		return predicates[0], nil
	default:
		return actionexecution.And(predicates...), nil
	}
}
...
type BazelInvocationWhereInput struct {
	...
	HasTagsWith []*InvocationTagWhereInput `json:"hasTagsWith,omitempty"`
	...
	// "action_executions" edge predicates.
	HasActionExecutions     *bool                        `json:"hasActionExecutions,omitempty"`
	HasActionExecutionsWith []*ActionExecutionWhereInput `json:"hasActionExecutionsWith,omitempty"`
...
func (i *BazelInvocationWhereInput) P() (predicate.BazelInvocation, error) {
	...
	if i.Username != nil {
		predicates = append(predicates, bazelinvocation.UsernameEQ(*i.Username))
	}
	if i.UsernameNEQ != nil {
		predicates = append(predicates, bazelinvocation.UsernameNEQ(*i.UsernameNEQ))
	}
	if len(i.UsernameIn) > 0 {
		predicates = append(predicates, bazelinvocation.UsernameIn(i.UsernameIn...))
	}
	if len(i.UsernameNotIn) > 0 {
		predicates = append(predicates, bazelinvocation.UsernameNotIn(i.UsernameNotIn...))
	}
	if i.UsernameGT != nil {
		predicates = append(predicates, bazelinvocation.UsernameGT(*i.UsernameGT))
	}
	if i.UsernameGTE != nil {
		predicates = append(predicates, bazelinvocation.UsernameGTE(*i.UsernameGTE))
	}
	if i.UsernameLT != nil {
		predicates = append(predicates, bazelinvocation.UsernameLT(*i.UsernameLT))
	}
	if i.UsernameLTE != nil {
		predicates = append(predicates, bazelinvocation.UsernameLTE(*i.UsernameLTE))
	}
	if i.UsernameContains != nil {
		predicates = append(predicates, bazelinvocation.UsernameContains(*i.UsernameContains))
	}
	if i.UsernameHasPrefix != nil {
		predicates = append(predicates, bazelinvocation.UsernameHasPrefix(*i.UsernameHasPrefix))
	}
	if i.UsernameHasSuffix != nil {
		predicates = append(predicates, bazelinvocation.UsernameHasSuffix(*i.UsernameHasSuffix))
	}
	if i.UsernameIsNil {
		predicates = append(predicates, bazelinvocation.UsernameIsNil())
	}
	if i.UsernameNotNil {
		predicates = append(predicates, bazelinvocation.UsernameNotNil())
	}
	if i.UsernameEqualFold != nil {
		predicates = append(predicates, bazelinvocation.UsernameEqualFold(*i.UsernameEqualFold))
	}
	if i.UsernameContainsFold != nil {
		predicates = append(predicates, bazelinvocation.UsernameContainsFold(*i.UsernameContainsFold))
	}
	if i.Hostname != nil {
	...
	if len(i.HasTagsWith) > 0 {
		with := make([]predicate.InvocationTag, 0, len(i.HasTagsWith))
		...
		predicates = append(predicates, bazelinvocation.HasTagsWith(with...))
	}
	...
	if i.HasActionExecutions != nil {
		p := bazelinvocation.HasActionExecutions()
		if !*i.HasActionExecutions {
			p = bazelinvocation.Not(p)
		}
		predicates = append(predicates, p)
	}
	if len(i.HasActionExecutionsWith) > 0 {
		with := make([]predicate.ActionExecution, 0, len(i.HasActionExecutionsWith))
		for _, w := range i.HasActionExecutionsWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasActionExecutionsWith'", err)
			}
			with = append(with, p)
		}
		predicates = append(predicates, bazelinvocation.HasActionExecutionsWith(with...))
	}
	if i.HasMetrics != nil {
...
type BuildWhereInput struct {
	...
	// "tags" edge predicates.
	HasTags     *bool                 `json:"hasTags,omitempty"`
	HasTagsWith []*BuildTagWhereInput `json:"hasTagsWith,omitempty"`
}
...
func (i *BuildWhereInput) P() (predicate.Build, error) {
	...
	if len(i.HasTagsWith) > 0 {
		with := make([]predicate.BuildTag, 0, len(i.HasTagsWith))
		for _, w := range i.HasTagsWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasTagsWith'", err)
		...
		predicates = append(predicates, build.HasTagsWith(with...))
	}
	switch len(predicates) {
	case 0:
...
// BuildTagWhereInput represents a where input for filtering BuildTag queries.
type BuildTagWhereInput struct {
	Predicates []predicate.BuildTag  `json:"-"`
	Not        *BuildTagWhereInput   `json:"not,omitempty"`
	Or         []*BuildTagWhereInput `json:"or,omitempty"`
	And        []*BuildTagWhereInput `json:"and,omitempty"`
...
// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *BuildTagWhereInput) AddPredicates(predicates ...predicate.BuildTag) {
	i.Predicates = append(i.Predicates, predicates...)
}

// Filter applies the BuildTagWhereInput filter on the BuildTagQuery builder.
func (i *BuildTagWhereInput) Filter(q *BuildTagQuery) (*BuildTagQuery, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyBuildTagWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyBuildTagWhereInput is returned in case the BuildTagWhereInput is empty.
var ErrEmptyBuildTagWhereInput = errors.New("ent: empty predicate BuildTagWhereInput")

// P returns a predicate for filtering buildtags.
// An error is returned if the input is empty or invalid.
func (i *BuildTagWhereInput) P() (predicate.BuildTag, error) {
	var predicates []predicate.BuildTag
	if i.Not != nil {
		p, err := i.Not.P()
		if err != nil {
			return nil, fmt.Errorf("%w: field 'not'", err)
		}
		predicates = append(predicates, buildtag.Not(p))
	}
	switch n := len(i.Or); {
	case n == 1:
		p, err := i.Or[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		or := make([]predicate.BuildTag, 0, n)
		for _, w := range i.Or {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'or'", err)
		...
		predicates = append(predicates, buildtag.Or(or...))
	}
	switch n := len(i.And); {
	case n == 1:
		p, err := i.And[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		and := make([]predicate.BuildTag, 0, n)
		for _, w := range i.And {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'and'", err)
		...
		predicates = append(predicates, buildtag.And(and...))
	}
	predicates = append(predicates, i.Predicates...)
	if i.ID != nil {
		predicates = append(predicates, buildtag.IDEQ(*i.ID))
	}
	if i.IDNEQ != nil {
		predicates = append(predicates, buildtag.IDNEQ(*i.IDNEQ))
	}
	if len(i.IDIn) > 0 {
		predicates = append(predicates, buildtag.IDIn(i.IDIn...))
	}
	if len(i.IDNotIn) > 0 {
		predicates = append(predicates, buildtag.IDNotIn(i.IDNotIn...))
	}
	if i.IDGT != nil {
		predicates = append(predicates, buildtag.IDGT(*i.IDGT))
	}
	if i.IDGTE != nil {
		predicates = append(predicates, buildtag.IDGTE(*i.IDGTE))
	}
	if i.IDLT != nil {
		predicates = append(predicates, buildtag.IDLT(*i.IDLT))
	}
	if i.IDLTE != nil {
		predicates = append(predicates, buildtag.IDLTE(*i.IDLTE))
	}
	if i.Key != nil {
		predicates = append(predicates, buildtag.KeyEQ(*i.Key))
	}
	if i.KeyNEQ != nil {
		predicates = append(predicates, buildtag.KeyNEQ(*i.KeyNEQ))
	}
	if len(i.KeyIn) > 0 {
		predicates = append(predicates, buildtag.KeyIn(i.KeyIn...))
	}
	if len(i.KeyNotIn) > 0 {
		predicates = append(predicates, buildtag.KeyNotIn(i.KeyNotIn...))
	}
	if i.KeyGT != nil {
		predicates = append(predicates, buildtag.KeyGT(*i.KeyGT))
	}
	if i.KeyGTE != nil {
		predicates = append(predicates, buildtag.KeyGTE(*i.KeyGTE))
	}
	if i.KeyLT != nil {
		predicates = append(predicates, buildtag.KeyLT(*i.KeyLT))
	}
	if i.KeyLTE != nil {
		predicates = append(predicates, buildtag.KeyLTE(*i.KeyLTE))
	}
	if i.KeyContains != nil {
		predicates = append(predicates, buildtag.KeyContains(*i.KeyContains))
	}
	if i.KeyHasPrefix != nil {
		predicates = append(predicates, buildtag.KeyHasPrefix(*i.KeyHasPrefix))
	}
	if i.KeyHasSuffix != nil {
		predicates = append(predicates, buildtag.KeyHasSuffix(*i.KeyHasSuffix))
	}
	if i.KeyEqualFold != nil {
		predicates = append(predicates, buildtag.KeyEqualFold(*i.KeyEqualFold))
	}
	if i.KeyContainsFold != nil {
		predicates = append(predicates, buildtag.KeyContainsFold(*i.KeyContainsFold))
	}
	if i.Value != nil {
		predicates = append(predicates, buildtag.ValueEQ(*i.Value))
	}
	if i.ValueNEQ != nil {
		predicates = append(predicates, buildtag.ValueNEQ(*i.ValueNEQ))
	}
	if len(i.ValueIn) > 0 {
		predicates = append(predicates, buildtag.ValueIn(i.ValueIn...))
	}
	if len(i.ValueNotIn) > 0 {
		predicates = append(predicates, buildtag.ValueNotIn(i.ValueNotIn...))
	}
	if i.ValueGT != nil {
		predicates = append(predicates, buildtag.ValueGT(*i.ValueGT))
	}
	if i.ValueGTE != nil {
		predicates = append(predicates, buildtag.ValueGTE(*i.ValueGTE))
	}
	if i.ValueLT != nil {
		predicates = append(predicates, buildtag.ValueLT(*i.ValueLT))
	}
	if i.ValueLTE != nil {
		predicates = append(predicates, buildtag.ValueLTE(*i.ValueLTE))
	}
	if i.ValueContains != nil {
		predicates = append(predicates, buildtag.ValueContains(*i.ValueContains))
	}
	if i.ValueHasPrefix != nil {
		predicates = append(predicates, buildtag.ValueHasPrefix(*i.ValueHasPrefix))
	}
	if i.ValueHasSuffix != nil {
		predicates = append(predicates, buildtag.ValueHasSuffix(*i.ValueHasSuffix))
	}
	if i.ValueEqualFold != nil {
		predicates = append(predicates, buildtag.ValueEqualFold(*i.ValueEqualFold))
	}
	if i.ValueContainsFold != nil {
		predicates = append(predicates, buildtag.ValueContainsFold(*i.ValueContainsFold))
	}
	...
	if len(i.HasBuildWith) > 0 {
		...
		predicates = append(predicates, buildtag.HasBuildWith(with...))
	}
	switch len(predicates) {
	case 0:
		return nil, ErrEmptyBuildTagWhereInput
	case 1:
		return predicates[0], nil
	default:
		return buildtag.And(predicates...), nil
	}
}
...
func (i *ConfigurationWhereInput) P() (predicate.Configuration, error) {
	...
	if i.HasActionExecutions != nil {
		p := configuration.HasActionExecutions()
		if !*i.HasActionExecutions {
			p = configuration.Not(p)
		}
		predicates = append(predicates, p)
	...
	if len(i.HasActionExecutionsWith) > 0 {
		...
		predicates = append(predicates, configuration.HasActionExecutionsWith(with...))
	}
	switch len(predicates) {
	case 0:
...
type DigestWhereInput struct {
	...
	Not        *DigestWhereInput   `json:"not,omitempty"`
	Or         []*DigestWhereInput `json:"or,omitempty"`
	And        []*DigestWhereInput `json:"and,omitempty"`
	...
	Rev2InstanceName             *string  `json:"rev2InstanceName,omitempty"`
	Rev2InstanceNameNEQ          *string  `json:"rev2InstanceNameNEQ,omitempty"`
	Rev2InstanceNameIn           []string `json:"rev2InstanceNameIn,omitempty"`
	Rev2InstanceNameNotIn        []string `json:"rev2InstanceNameNotIn,omitempty"`
	Rev2InstanceNameGT           *string  `json:"rev2InstanceNameGT,omitempty"`
	Rev2InstanceNameGTE          *string  `json:"rev2InstanceNameGTE,omitempty"`
	Rev2InstanceNameLT           *string  `json:"rev2InstanceNameLT,omitempty"`
	Rev2InstanceNameLTE          *string  `json:"rev2InstanceNameLTE,omitempty"`
	Rev2InstanceNameContains     *string  `json:"rev2InstanceNameContains,omitempty"`
	Rev2InstanceNameHasPrefix    *string  `json:"rev2InstanceNameHasPrefix,omitempty"`
	Rev2InstanceNameHasSuffix    *string  `json:"rev2InstanceNameHasSuffix,omitempty"`
	Rev2InstanceNameEqualFold    *string  `json:"rev2InstanceNameEqualFold,omitempty"`
	Rev2InstanceNameContainsFold *string  `json:"rev2InstanceNameContainsFold,omitempty"`

	// "digest_function" field predicates.
	DigestFunction      *int16  `json:"digestFunction,omitempty"`
	DigestFunctionNEQ   *int16  `json:"digestFunctionNEQ,omitempty"`
	DigestFunctionIn    []int16 `json:"digestFunctionIn,omitempty"`
	DigestFunctionNotIn []int16 `json:"digestFunctionNotIn,omitempty"`
	DigestFunctionGT    *int16  `json:"digestFunctionGT,omitempty"`
	DigestFunctionGTE   *int16  `json:"digestFunctionGTE,omitempty"`
	DigestFunctionLT    *int16  `json:"digestFunctionLT,omitempty"`
	DigestFunctionLTE   *int16  `json:"digestFunctionLTE,omitempty"`
...
// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *DigestWhereInput) AddPredicates(predicates ...predicate.Digest) {
	i.Predicates = append(i.Predicates, predicates...)
}

// Filter applies the DigestWhereInput filter on the DigestQuery builder.
func (i *DigestWhereInput) Filter(q *DigestQuery) (*DigestQuery, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyDigestWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyDigestWhereInput is returned in case the DigestWhereInput is empty.
var ErrEmptyDigestWhereInput = errors.New("ent: empty predicate DigestWhereInput")

// P returns a predicate for filtering digests.
// An error is returned if the input is empty or invalid.
func (i *DigestWhereInput) P() (predicate.Digest, error) {
	var predicates []predicate.Digest
	if i.Not != nil {
		p, err := i.Not.P()
		if err != nil {
			return nil, fmt.Errorf("%w: field 'not'", err)
		}
		predicates = append(predicates, digest.Not(p))
	}
	switch n := len(i.Or); {
	case n == 1:
		p, err := i.Or[0].P()
	...
	case n > 1:
		...
		predicates = append(predicates, digest.Or(or...))
	}
	switch n := len(i.And); {
	case n == 1:
		p, err := i.And[0].P()
	...
	case n > 1:
		...
		predicates = append(predicates, digest.And(and...))
	}
	predicates = append(predicates, i.Predicates...)
	if i.ID != nil {
		predicates = append(predicates, digest.IDEQ(*i.ID))
	}
	if i.IDNEQ != nil {
		predicates = append(predicates, digest.IDNEQ(*i.IDNEQ))
	}
	if len(i.IDIn) > 0 {
		predicates = append(predicates, digest.IDIn(i.IDIn...))
	}
	if len(i.IDNotIn) > 0 {
		predicates = append(predicates, digest.IDNotIn(i.IDNotIn...))
	}
	if i.IDGT != nil {
		predicates = append(predicates, digest.IDGT(*i.IDGT))
	}
	if i.IDGTE != nil {
		predicates = append(predicates, digest.IDGTE(*i.IDGTE))
	}
	if i.IDLT != nil {
		predicates = append(predicates, digest.IDLT(*i.IDLT))
	}
	if i.IDLTE != nil {
		predicates = append(predicates, digest.IDLTE(*i.IDLTE))
	}
	if i.Rev2InstanceName != nil {
		predicates = append(predicates, digest.Rev2InstanceNameEQ(*i.Rev2InstanceName))
	}
	if i.Rev2InstanceNameNEQ != nil {
		predicates = append(predicates, digest.Rev2InstanceNameNEQ(*i.Rev2InstanceNameNEQ))
	}
	if len(i.Rev2InstanceNameIn) > 0 {
		predicates = append(predicates, digest.Rev2InstanceNameIn(i.Rev2InstanceNameIn...))
	}
	if len(i.Rev2InstanceNameNotIn) > 0 {
		predicates = append(predicates, digest.Rev2InstanceNameNotIn(i.Rev2InstanceNameNotIn...))
	}
	if i.Rev2InstanceNameGT != nil {
		predicates = append(predicates, digest.Rev2InstanceNameGT(*i.Rev2InstanceNameGT))
	}
	if i.Rev2InstanceNameGTE != nil {
		predicates = append(predicates, digest.Rev2InstanceNameGTE(*i.Rev2InstanceNameGTE))
	}
	if i.Rev2InstanceNameLT != nil {
		predicates = append(predicates, digest.Rev2InstanceNameLT(*i.Rev2InstanceNameLT))
	}
	if i.Rev2InstanceNameLTE != nil {
		predicates = append(predicates, digest.Rev2InstanceNameLTE(*i.Rev2InstanceNameLTE))
	}
	if i.Rev2InstanceNameContains != nil {
		predicates = append(predicates, digest.Rev2InstanceNameContains(*i.Rev2InstanceNameContains))
	}
	if i.Rev2InstanceNameHasPrefix != nil {
		predicates = append(predicates, digest.Rev2InstanceNameHasPrefix(*i.Rev2InstanceNameHasPrefix))
	}
	if i.Rev2InstanceNameHasSuffix != nil {
		predicates = append(predicates, digest.Rev2InstanceNameHasSuffix(*i.Rev2InstanceNameHasSuffix))
	}
	if i.Rev2InstanceNameEqualFold != nil {
		predicates = append(predicates, digest.Rev2InstanceNameEqualFold(*i.Rev2InstanceNameEqualFold))
	}
	if i.Rev2InstanceNameContainsFold != nil {
		predicates = append(predicates, digest.Rev2InstanceNameContainsFold(*i.Rev2InstanceNameContainsFold))
	}
	if i.DigestFunction != nil {
		predicates = append(predicates, digest.DigestFunctionEQ(*i.DigestFunction))
	}
	if i.DigestFunctionNEQ != nil {
		predicates = append(predicates, digest.DigestFunctionNEQ(*i.DigestFunctionNEQ))
	}
	if len(i.DigestFunctionIn) > 0 {
		predicates = append(predicates, digest.DigestFunctionIn(i.DigestFunctionIn...))
	}
	if len(i.DigestFunctionNotIn) > 0 {
		predicates = append(predicates, digest.DigestFunctionNotIn(i.DigestFunctionNotIn...))
	}
	if i.DigestFunctionGT != nil {
		predicates = append(predicates, digest.DigestFunctionGT(*i.DigestFunctionGT))
	}
	if i.DigestFunctionGTE != nil {
		predicates = append(predicates, digest.DigestFunctionGTE(*i.DigestFunctionGTE))
	}
	if i.DigestFunctionLT != nil {
		predicates = append(predicates, digest.DigestFunctionLT(*i.DigestFunctionLT))
	}
	if i.DigestFunctionLTE != nil {
		predicates = append(predicates, digest.DigestFunctionLTE(*i.DigestFunctionLTE))
	}
	if i.SizeBytes != nil {
		predicates = append(predicates, digest.SizeBytesEQ(*i.SizeBytes))
	}
	if i.SizeBytesNEQ != nil {
		predicates = append(predicates, digest.SizeBytesNEQ(*i.SizeBytesNEQ))
	}
	if len(i.SizeBytesIn) > 0 {
		predicates = append(predicates, digest.SizeBytesIn(i.SizeBytesIn...))
	}
	if len(i.SizeBytesNotIn) > 0 {
		predicates = append(predicates, digest.SizeBytesNotIn(i.SizeBytesNotIn...))
	}
	if i.SizeBytesGT != nil {
		predicates = append(predicates, digest.SizeBytesGT(*i.SizeBytesGT))
	}
	if i.SizeBytesGTE != nil {
		predicates = append(predicates, digest.SizeBytesGTE(*i.SizeBytesGTE))
	}
	if i.SizeBytesLT != nil {
		predicates = append(predicates, digest.SizeBytesLT(*i.SizeBytesLT))
	}
	if i.SizeBytesLTE != nil {
		predicates = append(predicates, digest.SizeBytesLTE(*i.SizeBytesLTE))
	}
	...
	if len(i.HasFilesWith) > 0 {
		...
		predicates = append(predicates, digest.HasFilesWith(with...))
	}
	switch len(predicates) {
	case 0:
		return nil, ErrEmptyDigestWhereInput
	case 1:
		return predicates[0], nil
	default:
...
type FileWhereInput struct {
	...
	DigestIDNEQ   *int64  `json:"digestIDNEQ,omitempty"`
	DigestIDIn    []int64 `json:"digestIDIn,omitempty"`
	DigestIDNotIn []int64 `json:"digestIDNotIn,omitempty"`

	// "digest" edge predicates.
	HasDigest     *bool               `json:"hasDigest,omitempty"`
	HasDigestWith []*DigestWhereInput `json:"hasDigestWith,omitempty"`
...
func (i *FileWhereInput) P() (predicate.File, error) {
	...
	if i.DigestID != nil {
		predicates = append(predicates, file.DigestIDEQ(*i.DigestID))
	}
	if i.DigestIDNEQ != nil {
		predicates = append(predicates, file.DigestIDNEQ(*i.DigestIDNEQ))
	}
	if len(i.DigestIDIn) > 0 {
		predicates = append(predicates, file.DigestIDIn(i.DigestIDIn...))
	}
	if len(i.DigestIDNotIn) > 0 {
		predicates = append(predicates, file.DigestIDNotIn(i.DigestIDNotIn...))
	}
	...
	if len(i.HasDigestWith) > 0 {
		with := make([]predicate.Digest, 0, len(i.HasDigestWith))
		for _, w := range i.HasDigestWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasDigestWith'", err)
			}
			with = append(with, p)
		}
		predicates = append(predicates, file.HasDigestWith(with...))
	}
	if i.HasFilePath != nil {
		p := file.HasFilePath()
		if !*i.HasFilePath {
			p = file.Not(p)
		}
	...
	if len(i.HasFilePathWith) > 0 {
		with := make([]predicate.FilePath, 0, len(i.HasFilePathWith))
		for _, w := range i.HasFilePathWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasFilePathWith'", err)
			}
			with = append(with, p)
		}
...
// FilePathWhereInput represents a where input for filtering FilePath queries.
type FilePathWhereInput struct {
	Predicates []predicate.FilePath  `json:"-"`
	Not        *FilePathWhereInput   `json:"not,omitempty"`
	Or         []*FilePathWhereInput `json:"or,omitempty"`
	And        []*FilePathWhereInput `json:"and,omitempty"`
	...
	HasBepInstanceName     *bool                     `json:"hasBepInstanceName,omitempty"`
	HasBepInstanceNameWith []*InstanceNameWhereInput `json:"hasBepInstanceNameWith,omitempty"`
...
// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *FilePathWhereInput) AddPredicates(predicates ...predicate.FilePath) {
	i.Predicates = append(i.Predicates, predicates...)
}

// Filter applies the FilePathWhereInput filter on the FilePathQuery builder.
func (i *FilePathWhereInput) Filter(q *FilePathQuery) (*FilePathQuery, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyFilePathWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyFilePathWhereInput is returned in case the FilePathWhereInput is empty.
var ErrEmptyFilePathWhereInput = errors.New("ent: empty predicate FilePathWhereInput")

// P returns a predicate for filtering filepaths.
// An error is returned if the input is empty or invalid.
func (i *FilePathWhereInput) P() (predicate.FilePath, error) {
	var predicates []predicate.FilePath
	if i.Not != nil {
		p, err := i.Not.P()
		if err != nil {
			return nil, fmt.Errorf("%w: field 'not'", err)
		}
		predicates = append(predicates, filepath.Not(p))
	}
	switch n := len(i.Or); {
	case n == 1:
		p, err := i.Or[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		or := make([]predicate.FilePath, 0, n)
		for _, w := range i.Or {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'or'", err)
		...
		predicates = append(predicates, filepath.Or(or...))
	}
	switch n := len(i.And); {
	case n == 1:
		p, err := i.And[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		and := make([]predicate.FilePath, 0, n)
		for _, w := range i.And {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'and'", err)
		...
		predicates = append(predicates, filepath.And(and...))
	}
	predicates = append(predicates, i.Predicates...)
	if i.ID != nil {
		predicates = append(predicates, filepath.IDEQ(*i.ID))
	}
	if i.IDNEQ != nil {
		predicates = append(predicates, filepath.IDNEQ(*i.IDNEQ))
	}
	if len(i.IDIn) > 0 {
		predicates = append(predicates, filepath.IDIn(i.IDIn...))
	}
	if len(i.IDNotIn) > 0 {
		predicates = append(predicates, filepath.IDNotIn(i.IDNotIn...))
	}
	if i.IDGT != nil {
		predicates = append(predicates, filepath.IDGT(*i.IDGT))
	}
	if i.IDGTE != nil {
		predicates = append(predicates, filepath.IDGTE(*i.IDGTE))
	}
	if i.IDLT != nil {
		predicates = append(predicates, filepath.IDLT(*i.IDLT))
	}
	if i.IDLTE != nil {
		predicates = append(predicates, filepath.IDLTE(*i.IDLTE))
	}
	if i.Path != nil {
		predicates = append(predicates, filepath.PathEQ(*i.Path))
	}
	if i.PathNEQ != nil {
		predicates = append(predicates, filepath.PathNEQ(*i.PathNEQ))
	}
	if len(i.PathIn) > 0 {
		predicates = append(predicates, filepath.PathIn(i.PathIn...))
	}
	if len(i.PathNotIn) > 0 {
		predicates = append(predicates, filepath.PathNotIn(i.PathNotIn...))
	}
	if i.PathGT != nil {
		predicates = append(predicates, filepath.PathGT(*i.PathGT))
	}
	if i.PathGTE != nil {
		predicates = append(predicates, filepath.PathGTE(*i.PathGTE))
	}
	if i.PathLT != nil {
		predicates = append(predicates, filepath.PathLT(*i.PathLT))
	}
	if i.PathLTE != nil {
		predicates = append(predicates, filepath.PathLTE(*i.PathLTE))
	}
	if i.PathContains != nil {
		predicates = append(predicates, filepath.PathContains(*i.PathContains))
	}
	if i.PathHasPrefix != nil {
		predicates = append(predicates, filepath.PathHasPrefix(*i.PathHasPrefix))
	}
	if i.PathHasSuffix != nil {
		predicates = append(predicates, filepath.PathHasSuffix(*i.PathHasSuffix))
	}
	if i.PathEqualFold != nil {
		predicates = append(predicates, filepath.PathEqualFold(*i.PathEqualFold))
	}
	if i.PathContainsFold != nil {
		predicates = append(predicates, filepath.PathContainsFold(*i.PathContainsFold))
	}

	if i.HasBepInstanceName != nil {
		p := filepath.HasBepInstanceName()
		if !*i.HasBepInstanceName {
			p = filepath.Not(p)
		}
		predicates = append(predicates, p)
	}
	if len(i.HasBepInstanceNameWith) > 0 {
		with := make([]predicate.InstanceName, 0, len(i.HasBepInstanceNameWith))
		for _, w := range i.HasBepInstanceNameWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasBepInstanceNameWith'", err)
			}
			with = append(with, p)
		}
		predicates = append(predicates, filepath.HasBepInstanceNameWith(with...))
	}
	if i.HasFiles != nil {
		p := filepath.HasFiles()
		if !*i.HasFiles {
	...
	if len(i.HasFilesWith) > 0 {
		...
		predicates = append(predicates, filepath.HasFilesWith(with...))
	}
	switch len(predicates) {
	case 0:
		return nil, ErrEmptyFilePathWhereInput
	case 1:
		return predicates[0], nil
	default:
		return filepath.And(predicates...), nil
	}
}
...
type InstanceNameWhereInput struct {
	...
	HasFilePaths     *bool                 `json:"hasFilePaths,omitempty"`
	HasFilePathsWith []*FilePathWhereInput `json:"hasFilePathsWith,omitempty"`
}
...
func (i *InstanceNameWhereInput) P() (predicate.InstanceName, error) {
	...
	if i.HasFilePaths != nil {
		p := instancename.HasFilePaths()
		if !*i.HasFilePaths {
			p = instancename.Not(p)
		}
		predicates = append(predicates, p)
	}
	if len(i.HasFilePathsWith) > 0 {
		with := make([]predicate.FilePath, 0, len(i.HasFilePathsWith))
		for _, w := range i.HasFilePathsWith {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'HasFilePathsWith'", err)
			}
			with = append(with, p)
		}
		predicates = append(predicates, instancename.HasFilePathsWith(with...))
	}
	switch len(predicates) {
	case 0:
...
type InvocationTagWhereInput struct {
	...
	Not        *InvocationTagWhereInput   `json:"not,omitempty"`
	Or         []*InvocationTagWhereInput `json:"or,omitempty"`
	And        []*InvocationTagWhereInput `json:"and,omitempty"`
...
// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *InvocationTagWhereInput) AddPredicates(predicates ...predicate.InvocationTag) {
	i.Predicates = append(i.Predicates, predicates...)
}

// Filter applies the InvocationTagWhereInput filter on the InvocationTagQuery builder.
func (i *InvocationTagWhereInput) Filter(q *InvocationTagQuery) (*InvocationTagQuery, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
	if err != nil {
		if err == ErrEmptyInvocationTagWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptyInvocationTagWhereInput is returned in case the InvocationTagWhereInput is empty.
var ErrEmptyInvocationTagWhereInput = errors.New("ent: empty predicate InvocationTagWhereInput")

// P returns a predicate for filtering invocationtags.
// An error is returned if the input is empty or invalid.
func (i *InvocationTagWhereInput) P() (predicate.InvocationTag, error) {
	var predicates []predicate.InvocationTag
	if i.Not != nil {
		p, err := i.Not.P()
		if err != nil {
			return nil, fmt.Errorf("%w: field 'not'", err)
		}
		predicates = append(predicates, invocationtag.Not(p))
	}
	switch n := len(i.Or); {
	case n == 1:
		p, err := i.Or[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		or := make([]predicate.InvocationTag, 0, n)
		for _, w := range i.Or {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'or'", err)
		...
		predicates = append(predicates, invocationtag.Or(or...))
	}
	switch n := len(i.And); {
	case n == 1:
		p, err := i.And[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		and := make([]predicate.InvocationTag, 0, n)
		for _, w := range i.And {
			p, err := w.P()
			if err != nil {
				return nil, fmt.Errorf("%w: field 'and'", err)
		...
		predicates = append(predicates, invocationtag.And(and...))
	}
	predicates = append(predicates, i.Predicates...)
	if i.ID != nil {
		predicates = append(predicates, invocationtag.IDEQ(*i.ID))
	}
	if i.IDNEQ != nil {
		predicates = append(predicates, invocationtag.IDNEQ(*i.IDNEQ))
	}
	if len(i.IDIn) > 0 {
		predicates = append(predicates, invocationtag.IDIn(i.IDIn...))
	}
	if len(i.IDNotIn) > 0 {
		predicates = append(predicates, invocationtag.IDNotIn(i.IDNotIn...))
	}
	if i.IDGT != nil {
		predicates = append(predicates, invocationtag.IDGT(*i.IDGT))
	}
	if i.IDGTE != nil {
		predicates = append(predicates, invocationtag.IDGTE(*i.IDGTE))
	}
	if i.IDLT != nil {
		predicates = append(predicates, invocationtag.IDLT(*i.IDLT))
	}
	if i.IDLTE != nil {
		predicates = append(predicates, invocationtag.IDLTE(*i.IDLTE))
	}
	if i.Key != nil {
		predicates = append(predicates, invocationtag.KeyEQ(*i.Key))
	}
	if i.KeyNEQ != nil {
		predicates = append(predicates, invocationtag.KeyNEQ(*i.KeyNEQ))
	}
	if len(i.KeyIn) > 0 {
		predicates = append(predicates, invocationtag.KeyIn(i.KeyIn...))
	}
	if len(i.KeyNotIn) > 0 {
		predicates = append(predicates, invocationtag.KeyNotIn(i.KeyNotIn...))
	}
	if i.KeyGT != nil {
		predicates = append(predicates, invocationtag.KeyGT(*i.KeyGT))
	}
	if i.KeyGTE != nil {
		predicates = append(predicates, invocationtag.KeyGTE(*i.KeyGTE))
	}
	if i.KeyLT != nil {
		predicates = append(predicates, invocationtag.KeyLT(*i.KeyLT))
	}
	if i.KeyLTE != nil {
		predicates = append(predicates, invocationtag.KeyLTE(*i.KeyLTE))
	}
	if i.KeyContains != nil {
		predicates = append(predicates, invocationtag.KeyContains(*i.KeyContains))
	}
	if i.KeyHasPrefix != nil {
		predicates = append(predicates, invocationtag.KeyHasPrefix(*i.KeyHasPrefix))
	}
	if i.KeyHasSuffix != nil {
		predicates = append(predicates, invocationtag.KeyHasSuffix(*i.KeyHasSuffix))
	}
	if i.KeyEqualFold != nil {
		predicates = append(predicates, invocationtag.KeyEqualFold(*i.KeyEqualFold))
	}
	if i.KeyContainsFold != nil {
		predicates = append(predicates, invocationtag.KeyContainsFold(*i.KeyContainsFold))
	}
	if i.Value != nil {
		predicates = append(predicates, invocationtag.ValueEQ(*i.Value))
	}
	if i.ValueNEQ != nil {
		predicates = append(predicates, invocationtag.ValueNEQ(*i.ValueNEQ))
	}
	if len(i.ValueIn) > 0 {
		predicates = append(predicates, invocationtag.ValueIn(i.ValueIn...))
	}
	if len(i.ValueNotIn) > 0 {
		predicates = append(predicates, invocationtag.ValueNotIn(i.ValueNotIn...))
	}
	if i.ValueGT != nil {
		predicates = append(predicates, invocationtag.ValueGT(*i.ValueGT))
	}
	if i.ValueGTE != nil {
		predicates = append(predicates, invocationtag.ValueGTE(*i.ValueGTE))
	}
	if i.ValueLT != nil {
		predicates = append(predicates, invocationtag.ValueLT(*i.ValueLT))
	}
	if i.ValueLTE != nil {
		predicates = append(predicates, invocationtag.ValueLTE(*i.ValueLTE))
	}
	if i.ValueContains != nil {
		predicates = append(predicates, invocationtag.ValueContains(*i.ValueContains))
	}
	if i.ValueHasPrefix != nil {
		predicates = append(predicates, invocationtag.ValueHasPrefix(*i.ValueHasPrefix))
	}
	if i.ValueHasSuffix != nil {
		predicates = append(predicates, invocationtag.ValueHasSuffix(*i.ValueHasSuffix))
	}
	if i.ValueEqualFold != nil {
		predicates = append(predicates, invocationtag.ValueEqualFold(*i.ValueEqualFold))
	}
	if i.ValueContainsFold != nil {
		predicates = append(predicates, invocationtag.ValueContainsFold(*i.ValueContainsFold))
	}

	if i.HasBazelInvocation != nil {
		p := invocationtag.HasBazelInvocation()
		if !*i.HasBazelInvocation {
			p = invocationtag.Not(p)
		}
		predicates = append(predicates, p)
	}
	if len(i.HasBazelInvocationWith) > 0 {
		...
		predicates = append(predicates, invocationtag.HasBazelInvocationWith(with...))
	}
	switch len(predicates) {
	case 0:
		return nil, ErrEmptyInvocationTagWhereInput
	case 1:
		return predicates[0], nil
	default:
		return invocationtag.And(predicates...), nil
	}
}
...
type SourceControlWhereInput struct {
	...
	RefURLIsNil        bool     `json:"refURLIsNil,omitempty"`
	RefURLNotNil       bool     `json:"refURLNotNil,omitempty"`
	...
	CommitNEQ          *string  `json:"commitNEQ,omitempty"`
	CommitIn           []string `json:"commitIn,omitempty"`
	CommitNotIn        []string `json:"commitNotIn,omitempty"`
	CommitGT           *string  `json:"commitGT,omitempty"`
	CommitGTE          *string  `json:"commitGTE,omitempty"`
	CommitLT           *string  `json:"commitLT,omitempty"`
	CommitLTE          *string  `json:"commitLTE,omitempty"`
	CommitContains     *string  `json:"commitContains,omitempty"`
	CommitHasPrefix    *string  `json:"commitHasPrefix,omitempty"`
	CommitHasSuffix    *string  `json:"commitHasSuffix,omitempty"`
	CommitIsNil        bool     `json:"commitIsNil,omitempty"`
	CommitNotNil       bool     `json:"commitNotNil,omitempty"`
	CommitEqualFold    *string  `json:"commitEqualFold,omitempty"`
	CommitContainsFold *string  `json:"commitContainsFold,omitempty"`

	// "commit_url" field predicates.
	CommitURL             *string  `json:"commitURL,omitempty"`
	CommitURLNEQ          *string  `json:"commitURLNEQ,omitempty"`
	CommitURLIn           []string `json:"commitURLIn,omitempty"`
	CommitURLNotIn        []string `json:"commitURLNotIn,omitempty"`
	CommitURLGT           *string  `json:"commitURLGT,omitempty"`
	CommitURLGTE          *string  `json:"commitURLGTE,omitempty"`
	CommitURLLT           *string  `json:"commitURLLT,omitempty"`
	CommitURLLTE          *string  `json:"commitURLLTE,omitempty"`
	CommitURLContains     *string  `json:"commitURLContains,omitempty"`
	CommitURLHasPrefix    *string  `json:"commitURLHasPrefix,omitempty"`
	CommitURLHasSuffix    *string  `json:"commitURLHasSuffix,omitempty"`
	CommitURLIsNil        bool     `json:"commitURLIsNil,omitempty"`
	CommitURLNotNil       bool     `json:"commitURLNotNil,omitempty"`
	CommitURLEqualFold    *string  `json:"commitURLEqualFold,omitempty"`
	CommitURLContainsFold *string  `json:"commitURLContainsFold,omitempty"`
...
func (i *SourceControlWhereInput) P() (predicate.SourceControl, error) {
	...
	if i.Ref != nil {
		predicates = append(predicates, sourcecontrol.RefEQ(*i.Ref))
	}
	if i.RefNEQ != nil {
		predicates = append(predicates, sourcecontrol.RefNEQ(*i.RefNEQ))
	}
	if len(i.RefIn) > 0 {
		predicates = append(predicates, sourcecontrol.RefIn(i.RefIn...))
	}
	if len(i.RefNotIn) > 0 {
		predicates = append(predicates, sourcecontrol.RefNotIn(i.RefNotIn...))
	}
	if i.RefGT != nil {
		predicates = append(predicates, sourcecontrol.RefGT(*i.RefGT))
	}
	if i.RefGTE != nil {
		predicates = append(predicates, sourcecontrol.RefGTE(*i.RefGTE))
	}
	if i.RefLT != nil {
		predicates = append(predicates, sourcecontrol.RefLT(*i.RefLT))
	}
	if i.RefLTE != nil {
		predicates = append(predicates, sourcecontrol.RefLTE(*i.RefLTE))
	}
	if i.RefContains != nil {
		predicates = append(predicates, sourcecontrol.RefContains(*i.RefContains))
	}
	if i.RefHasPrefix != nil {
		predicates = append(predicates, sourcecontrol.RefHasPrefix(*i.RefHasPrefix))
	}
	if i.RefHasSuffix != nil {
		predicates = append(predicates, sourcecontrol.RefHasSuffix(*i.RefHasSuffix))
	}
	if i.RefIsNil {
		predicates = append(predicates, sourcecontrol.RefIsNil())
	}
	if i.RefNotNil {
		predicates = append(predicates, sourcecontrol.RefNotNil())
	}
	if i.RefEqualFold != nil {
		predicates = append(predicates, sourcecontrol.RefEqualFold(*i.RefEqualFold))
	}
	if i.RefContainsFold != nil {
		predicates = append(predicates, sourcecontrol.RefContainsFold(*i.RefContainsFold))
	}
	if i.RefURL != nil {
		predicates = append(predicates, sourcecontrol.RefURLEQ(*i.RefURL))
	}
	if i.RefURLNEQ != nil {
		predicates = append(predicates, sourcecontrol.RefURLNEQ(*i.RefURLNEQ))
	}
	if len(i.RefURLIn) > 0 {
		predicates = append(predicates, sourcecontrol.RefURLIn(i.RefURLIn...))
	}
	if len(i.RefURLNotIn) > 0 {
		predicates = append(predicates, sourcecontrol.RefURLNotIn(i.RefURLNotIn...))
	}
	if i.RefURLGT != nil {
		predicates = append(predicates, sourcecontrol.RefURLGT(*i.RefURLGT))
	}
	if i.RefURLGTE != nil {
		predicates = append(predicates, sourcecontrol.RefURLGTE(*i.RefURLGTE))
	}
	if i.RefURLLT != nil {
		predicates = append(predicates, sourcecontrol.RefURLLT(*i.RefURLLT))
	}
	if i.RefURLLTE != nil {
		predicates = append(predicates, sourcecontrol.RefURLLTE(*i.RefURLLTE))
	}
	if i.RefURLContains != nil {
		predicates = append(predicates, sourcecontrol.RefURLContains(*i.RefURLContains))
	}
	if i.RefURLHasPrefix != nil {
		predicates = append(predicates, sourcecontrol.RefURLHasPrefix(*i.RefURLHasPrefix))
	}
	if i.RefURLHasSuffix != nil {
		predicates = append(predicates, sourcecontrol.RefURLHasSuffix(*i.RefURLHasSuffix))
	}
	if i.RefURLIsNil {
		predicates = append(predicates, sourcecontrol.RefURLIsNil())
	}
	if i.RefURLNotNil {
		predicates = append(predicates, sourcecontrol.RefURLNotNil())
	}
	if i.RefURLEqualFold != nil {
		predicates = append(predicates, sourcecontrol.RefURLEqualFold(*i.RefURLEqualFold))
	}
	if i.RefURLContainsFold != nil {
		predicates = append(predicates, sourcecontrol.RefURLContainsFold(*i.RefURLContainsFold))
	}
	if i.Commit != nil {
		predicates = append(predicates, sourcecontrol.CommitEQ(*i.Commit))
	}
	if i.CommitNEQ != nil {
		predicates = append(predicates, sourcecontrol.CommitNEQ(*i.CommitNEQ))
	}
	if len(i.CommitIn) > 0 {
		predicates = append(predicates, sourcecontrol.CommitIn(i.CommitIn...))
	}
	if len(i.CommitNotIn) > 0 {
		predicates = append(predicates, sourcecontrol.CommitNotIn(i.CommitNotIn...))
	}
	if i.CommitGT != nil {
		predicates = append(predicates, sourcecontrol.CommitGT(*i.CommitGT))
	}
	if i.CommitGTE != nil {
		predicates = append(predicates, sourcecontrol.CommitGTE(*i.CommitGTE))
	}
	if i.CommitLT != nil {
		predicates = append(predicates, sourcecontrol.CommitLT(*i.CommitLT))
	}
	if i.CommitLTE != nil {
		predicates = append(predicates, sourcecontrol.CommitLTE(*i.CommitLTE))
	}
	if i.CommitContains != nil {
		predicates = append(predicates, sourcecontrol.CommitContains(*i.CommitContains))
	}
	if i.CommitHasPrefix != nil {
		predicates = append(predicates, sourcecontrol.CommitHasPrefix(*i.CommitHasPrefix))
	}
	if i.CommitHasSuffix != nil {
		predicates = append(predicates, sourcecontrol.CommitHasSuffix(*i.CommitHasSuffix))
	}
	if i.CommitIsNil {
		predicates = append(predicates, sourcecontrol.CommitIsNil())
	}
	if i.CommitNotNil {
		predicates = append(predicates, sourcecontrol.CommitNotNil())
	}
	if i.CommitEqualFold != nil {
		predicates = append(predicates, sourcecontrol.CommitEqualFold(*i.CommitEqualFold))
	}
	if i.CommitContainsFold != nil {
		predicates = append(predicates, sourcecontrol.CommitContainsFold(*i.CommitContainsFold))
	}
	if i.CommitURL != nil {
		predicates = append(predicates, sourcecontrol.CommitURLEQ(*i.CommitURL))
	}
	if i.CommitURLNEQ != nil {
		predicates = append(predicates, sourcecontrol.CommitURLNEQ(*i.CommitURLNEQ))
	}
	if len(i.CommitURLIn) > 0 {
		predicates = append(predicates, sourcecontrol.CommitURLIn(i.CommitURLIn...))
	}
	if len(i.CommitURLNotIn) > 0 {
		predicates = append(predicates, sourcecontrol.CommitURLNotIn(i.CommitURLNotIn...))
	}
	if i.CommitURLGT != nil {
		predicates = append(predicates, sourcecontrol.CommitURLGT(*i.CommitURLGT))
	}
	if i.CommitURLGTE != nil {
		predicates = append(predicates, sourcecontrol.CommitURLGTE(*i.CommitURLGTE))
	}
	if i.CommitURLLT != nil {
		predicates = append(predicates, sourcecontrol.CommitURLLT(*i.CommitURLLT))
	}
	if i.CommitURLLTE != nil {
		predicates = append(predicates, sourcecontrol.CommitURLLTE(*i.CommitURLLTE))
	}
	if i.CommitURLContains != nil {
		predicates = append(predicates, sourcecontrol.CommitURLContains(*i.CommitURLContains))
	}
	if i.CommitURLHasPrefix != nil {
		predicates = append(predicates, sourcecontrol.CommitURLHasPrefix(*i.CommitURLHasPrefix))
	}
	if i.CommitURLHasSuffix != nil {
		predicates = append(predicates, sourcecontrol.CommitURLHasSuffix(*i.CommitURLHasSuffix))
	}
	if i.CommitURLIsNil {
		predicates = append(predicates, sourcecontrol.CommitURLIsNil())
	}
	if i.CommitURLNotNil {
		predicates = append(predicates, sourcecontrol.CommitURLNotNil())
	}
	if i.CommitURLEqualFold != nil {
		predicates = append(predicates, sourcecontrol.CommitURLEqualFold(*i.CommitURLEqualFold))
	}
	if i.CommitURLContainsFold != nil {
		predicates = append(predicates, sourcecontrol.CommitURLContainsFold(*i.CommitURLContainsFold))
	}
